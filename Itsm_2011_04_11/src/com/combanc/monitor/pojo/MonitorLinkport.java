...
public class MonitorLinkport implements java.io.Serializable {
	...
	/** default constructor */
	public MonitorLinkport() {
	}

	/** full constructor */
	public MonitorLinkport(MonitorSubnet monitorSubnet, String ip, String port,
