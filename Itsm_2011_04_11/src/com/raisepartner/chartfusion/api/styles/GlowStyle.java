...
public final class GlowStyle extends Style {
	...
	/**
	 * The color of the glow in hex code (without #). The default value is
	 * FF0000
	 */
	 ...
	 * value is 8. Values that are a power of 2 (such as 2, 4, 8, 16 and 32) are
	 ...
	 * is 8. Values that are a power of 2 (such as 2, 4, 8, 16 and 32) are
	 * optimized to render more quickly than other values
	 */
	 ...
	 * medium quality, and a value of 3 is high quality. Glows with lower values
	 * are rendered quicker.
	 */
