...
public final class BevelStyle extends Style {
	...
	/**
	 * The offset distance of the bevel. Valid values are in pixels (floating
	 ...
	 * (floating point). The default value is 4. Values that are a power of 2
	 * (such as 2, 4, 8, 16, and 32) are optimized to render more quickly than
	 * other values
	 */
	...
	/**
	 * The number of times to apply the filter. The default value is 1, which is
	 * equivalent to low quality. A value of 2 is medium quality, and a value of
	 * 3 is high quality. Filters with lower values are rendered more quickly
	 */
