...
Ext.EventManager = function(){
    ...
    var removeAll = function(el){
     ...
     var fireDocReady = function(){
        if(!docReadyState){
			// ------------------------------yangguang 20090903 iframe加载问题 -> *代码替换*
        ...
        if(docReadyEvent && !Ext.isReady){ // ------------ yangguang 20090903 iframe加载问题 -> *添加 && !Ext.isReady*
            Ext.isReady = true; //  ------------ yangguang 20090903 iframe加载问题 -> *添加 Ext.isReady = true;*
			docReadyEvent.fire();
    ...
    var initDocReady = function(){
        ...
        if(Ext.isGecko || Ext.isOpera) {
			...
			// -------------------------------yangguang 20090903 iframe加载问题 -> *删除这段代码*
...
El.prototype = {
    ...
    setPositioning : function(pc){
		...
		// ---------------------------------yangguang 20090903 解决portal横向滚动条的问题 -> *代码替换*
	...
	//},
		...
		setOverflow : function(v){
    	if(v=='auto' && Ext.isMac && Ext.isGecko2){     		this.dom.style.overflow = 'hidden';
        	(function(){this.dom.style.overflowY = 'auto'; this.dom.style.overflowX='hidden';}).defer(1, this);
    	}else{
    		this.dom.style.overflowY=v;this.dom.style.overflowX='hidden';
    	}
	},
	// --------------------------------- yangguang 20090903 解决portal横向滚动条的问题 <-
...
Ext.extend(Ext.data.Connection, Ext.util.Observable, {
    ...
    request : function(o){
        if(this.fireEvent("beforerequest", this, o) !== false){
        	 ...
        	 * ajax请求前 清空状态栏信息  
        	 * */
        	if(Ext.StatusBar.showMsg != null)
        		Ext.StatusBar.showMsg("clear","");
