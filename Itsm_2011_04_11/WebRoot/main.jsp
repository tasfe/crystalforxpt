...
<frameset rows="98,*,41" cols="*" frameborder="yes" framespacing="0" bordercolor="#f8f9f4">
  <frame src="top.jsp" name="topFrame" scrolling="no" noresize frameborder="0">
  <frameset cols="194,*" framespacing="no" frameborder="no" bordercolor="#f8f9f4">
   ...
   <frame src="<%=path %>/license/getInfo.action" name="mainFrame" id="mainFrame" title="mainFrame" style="BORDER:#91A9BD 0px solid"/>
  </frameset>
