...
<body leftmargin="2" topmargin="0" marginwidth="0" marginheight="0" style="padding-right: 1px; padding-bottom: 2px; padding-top: 2px">
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td valign="top" id="mainright" height="100%">
			<table width="100%" border="0" cellspacing="0" cellpadding="1">
				<tr>
					<td width="1%" height="22" align="center" background="../images/main20100521_582.gif" style="color:#FFFFFF; font-weight:bold;padding-left:5px; padding-right:5px;"><img src="../images/modpass.gif" width="16" height="16"></td>
   					<td width="98%" background="../images/main20100521_582.gif" style="color:#FFFFFF; font-weight:bold;">我的工作</td>
				</tr>
				<tr>
				...
				<tr>
					<td valign="top" colspan="2">
						<table cellspacing=0 cellpadding=0 border=0 width="100%">
							<tr>
								<td nowrap>
									<table cellspacing=0  bgcolor="#b5d6e6" cellpadding=4 border=0 width="100%" style="border: 1px outset white">
										<tr>
											<td class="td-right" id="TongJi" style="padding: 8px">
												<table width="100%"  bgcolor="#b5d6e6" border="0" cellspacing="6" cellpadding="1">
													<tr>
														<td align="center" bgcolor="#b5d6e6">待受理服务:<a><br><br><font size="3" color="red"><b><s:property value="statistic1"></s:property></b></font><br></a></td>
														<td align="center" bgcolor="#b5d6e6">处理中的服务:<a><br><font size="3" color="red"><b><br><s:property value="statistic2"></s:property></b></font><br></a></td>			
														<!--  
														<td align="center" bgcolor="#b5d6e6">待处理问题:<a><br><br><font size="3" color="red"><b>0</b></font><br></a></td>
														<td align="center" bgcolor="#b5d6e6">待实施变更:<a><br><br><font size="3" color="red"><b>0</b></font><br></a></td>	
														<td align="center" bgcolor="#b5d6e6" style="border-right: 0px">参与的任务:<a ><br><br><font size="4" color="red"><b>0</b></font><br></a></td>	-->		
													</tr>
												</table>
												</td>
											</tr>
						...
						<table align="center" cellspacing=0 cellpadding=4 border=0  width="100%" class="datagrid" style="border: 1px outset white" bgcolor="#b5d6e6">
							<tr id="tab1" >
								<th width="15%" nowrap class="mmBtn">服务单号</th>
								<th width="10%" nowrap class="mmBtn">服务类别</th>
								<th width="5%" nowrap class="mmBtn">优先级</th>
								<th width="12%" nowrap class="mmBtn">申请时间</th>
								<th width="12%" nowrap class="mmBtn">希望完成时间</th>
								<th width="15%" nowrap class="mmBtn">剩余时间(小时)</th>
								<th width="5%" nowrap class="mmBtn">申请人</th>
								<th width="5%" nowrap class="mmBtn" style="text-align: center">查看</th>
							</tr>
							
							<tr id="tab11" style="display:none"> <td colspan="8" class="menu"><img src="../img/index.jpg" align="absMiddle">需要您反馈并关闭的服务请求:</td> </tr>							
							<s:iterator value="list5" var="serviceRequest">
								<tr>
									<td height="29"><script> document.getElementById('tab11').style.display='';</script>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="1%"><img src="../img/incident.gif" style="background-color: "></td>
												<td width="87%" nowrap>&nbsp;&nbsp;<s:property value="requestNo"/>&nbsp;&nbsp;</td>
											</tr>
										</table>
									</td>
									<td><s:property value="serviceCategory.itemZh"/></td>
									<td><s:property value="priorityLvl"/></td>
									<td><s:property value="submintTime"/></td>
									<td><s:property value="expectTime"/></td>
									 <td align="center">
						           		<script type = "text/javascript" >    
									...
									<td><s:property value="usersByRequestUser.truename"/></td>
									<td align=center nowrap><a href="show.action?serviceRequest.id=<s:property value="id" />"><img src='../img/view.jpg' border=0 width=18 height=18></a></td>
								</tr>
							</s:iterator>
							
							<tr  id="tab12" style="display:none"> <td colspan="8" class="menu"><img src="../img/index.jpg" align="absMiddle">需要您重新激活的挂起的请求:</td> </tr>							
							<s:iterator value="list7" var="serviceRequest">
								<tr>
									<td height="29"><script> document.getElementById('tab12').style.display='';</script>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="1%"><img src="../img/incident.gif" style="background-color: "></td>
												<td width="87%" nowrap>&nbsp;&nbsp;<s:property value="requestNo"/>&nbsp;&nbsp;</td>
							...
							<tr id="tab13" style="display:none"> <td colspan="8" class="menu"><img src="../img/index.jpg" align="absMiddle">您正在处理中的服务请求:</td> </tr>							
							<s:iterator value="list2" var="serviceRequest">
								<tr>
									<td height="29"><script> document.getElementById('tab13').style.display='';</script>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="1%"><img src="../img/incident.gif" style="background-color: "></td>
												<td width="87%" nowrap>&nbsp;&nbsp;<s:property value="requestNo"/>&nbsp;&nbsp;</td>
							...
							<tr  id="tab14" style="display:none"> <td colspan="8" class="menu"><img src="../img/index.jpg" align="absMiddle">需要您受理的服务请求:</td> </tr>							
							<s:iterator value="list1" var="serviceRequest">
								<tr>
									<td height="29"><script> document.getElementById('tab14').style.display='';</script>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td width="1%"><img src="../img/incident.gif" style="background-color: "></td>
												<td width="87%" nowrap>&nbsp;&nbsp;<s:property value="requestNo"/>&nbsp;&nbsp;</td>
			...
			<table cellspacing=0 cellpadding=0 border=0 width="100%">
				<tr>
					<td width="99%" valign="bottom" style="padding-bottom: 2px; padding-left: 1px">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td nowrap style="padding: 2px; padding-left: 0px; padding-top: 3px" valign="bottom">
					...
					<td align=right nowrap width="1%" style="padding-top: 5px; padding-bottom: 2px; padding-right: 1px">
					<!--	<input type="button" class="mmBtn" value="增加任务提示" onClick="window.open('../task/?NowAction=newnote','','width=500,height=300,scrollbars=no,menubar=no,resizable=no,top=180,left=186,status=yes')">
					  ...
					  -->	<input type="button" class="mmBtn" value="刷新" onClick="window.location.reload()">
					</td>
				</tr>
			</table>
		</td>
