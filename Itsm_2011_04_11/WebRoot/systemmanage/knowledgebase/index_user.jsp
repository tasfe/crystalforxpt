                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
                                <tr> 
                                  <td height="100%" valign="top" width="100%" style="border: 1px inset; border-bottom: 0px">
                                  		<s:form id="form1" name="from1" method="post" action="query2.action"  target="_blank" theme="simple" >
											<table width="100%" height="100%" border="0" cellpadding="5" cellspacing="0">
                          						...
                          						<tr> 
                            						<td align="right" valign="bottom" style="padding: 0px; padding-bottom: 8px"><img src="../img/addicon.jpg" width="140" height="138"></td>
                         						</tr>
                        					</table>
										</s:form>
									</td>
                        ...
                        <table width="100%" height="100%" border="0" cellpadding="1" cellspacing="0">
                          <tr> 
                            <td width="100%" height="99%" valign="top" bgColor="#FFFFFF"> 
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
                                <tr> 
                                  <td height="100%" valign="top" width="100%" style="border: 1px inset; border-bottom: 0px"><iframe frameborder="0" height="100%" width="100%" id="solution" name="solution" scrolling="yes" src="top2.action"></iframe>
                                  </td>
                                </tr>				
                              </table>
                             </td>
