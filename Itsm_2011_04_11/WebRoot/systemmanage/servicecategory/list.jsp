	...
	<head>
		...
		<script type="text/javascript" >
			function loadTop() {
				...
				topframe.location = "top.action?type=${type}";
			}			
		</script>
	</head>
		...
		<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#b5d6e6">
          ...
          <s:iterator value="serviceCategoryList" var="sc">
            <tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#e3f0f7'" onMouseOut="this.bgColor='#FFFFFF'">
              ...
              <td align="center"><img src="../images/del.gif"><a href="javascript:;" onClick="if(confirm('确认删除吗？')) parent.location='delete.action?serviceCategoryId=${sc.id}&type=<s:property value="type"/>&pid=<s:property value="pid"/>'">删除</a></td>
            </tr>
          </s:iterator>
        </table>
</body>
