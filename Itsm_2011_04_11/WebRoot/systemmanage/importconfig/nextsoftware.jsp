			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
				  ...
				  <tr>
				    <td valign="top"><table width="100%" cellpadding="2" cellspacing="1" bgcolor="#b5d6e6">
                      <TR title="条形码" bgColor="#f9f9f9">
                        <TD width="14%" height="27" noWrap bgcolor="#EBF4F5">条形码:</TD>
                        <TD width="86%" bgcolor="#FFFFFF"><INPUT id="Text_1" name="Text_1">                        </TD>
                      </TR>
                      <TR title="品牌" bgColor="#f9f9f9">
                        <TD width="14%" height="27" noWrap bgcolor="#EBF4F5">品牌:</TD>
                        <TD width="86%" bgcolor="#FFFFFF"><INPUT id="Text_2" name="Text_2">                        </TD>
                      </TR>
                      <TR title="规格一" bgColor="#f9f9f9">
                        <TD width="14%" height="27" noWrap bgcolor="#EBF4F5">规格一:</TD>
                        <TD width="86%" bgcolor="#FFFFFF"><INPUT id="Text_3" name="Text_3">                        </TD>
                      </TR>
                      <TR title="规格二" bgColor="#f9f9f9">
                        <TD width="14%" height="27" noWrap bgcolor="#EBF4F5">规格二:</TD>
                        <TD width="86%" bgcolor="#FFFFFF"><INPUT id="Text_4" name="Text_4">                        </TD>
                      </TR>
                      <TR title="规格三" bgColor="#f9f9f9">
                        <TD width="14%" height="27" noWrap bgcolor="#EBF4F5">规格三:</TD>
                        <TD width="86%" bgcolor="#FFFFFF"><INPUT id="Text_5" name="Text_5">                        </TD>
                      </TR>
                      <TR title="规格四" bgColor="#f9f9f9">
                        <TD width="14%" height="27" noWrap bgcolor="#EBF4F5">规格四:</TD>
                        <TD width="86%" bgcolor="#FFFFFF"><INPUT id="Text_6" name="Text_6">                        </TD>
                      </TR>
                      <TR title="型号" bgColor="#f9f9f9">
                        <TD width="14%" height="27" noWrap bgcolor="#EBF4F5">型号:</TD>
                        <TD width="86%" bgcolor="#FFFFFF"><INPUT id="Text_7" name="Text_7">                        </TD>
                      </TR>
                      <TR title="出厂批号" bgColor="#f9f9f9">
                        <TD width="14%" height="27" noWrap bgcolor="#EBF4F5">出厂批号:</TD>
                        <TD width="86%" bgcolor="#FFFFFF"><INPUT id="Text_8" name="Text_8">                        </TD>
                      </TR>
                      <TR title="单价" bgColor="#f9f9f9">
                        <TD width="14%" height="27" noWrap bgcolor="#EBF4F5">单价:</TD>
                        <TD width="86%" bgcolor="#FFFFFF"><INPUT id="Text_9" name="Text_9">                        </TD>
                      </TR>
                    </table></td>
				    </tr>
				  <tr onMouseDown="document.getElementById('Layer5').style.visibility='hidden'">
						...
						<tr>
						  ...
						  <table width="100%" height="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#b5d6e6">
							<tr>
							  ...
							  <td width="86%" bgcolor="#FFFFFF">
							  <input name="Total" id="Total" style="width: 30%" type="text" onKeyUp="if(this.value<1000){}else{this.value='1'}" value="1" title="Max: 999" maxlength="3">							  </td>
							</tr>
							<tr>
