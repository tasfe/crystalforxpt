  ...
  <tr>
	...
	<input type="hidden" name="DocNo" id="DocNo" value="">
                <tr> 
                  ...
                  <td width="85%" height="12" colspan="3" bgcolor="#EBF4F5"><input name="Title" type="text" id="Title" style="width: 100%" value="冯驰: 测试-开发项目 - 可行性分析 - xyz软件开发项目_业务可行性分析_V0001" maxlength="50"></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td width="35%" height="12" bgcolor="#EBF4F5"><input name="Writer" type="text" id="Writer" style="width: 80%" value="冯驰" maxlength="50"></td>
                ...
                <tr> 
                  ...
                  <td height="12" bgcolor="#EBF4F5"><input name="Insert_Date" type="text" id="Insert_Date" style="width: 80%" onClick="gfPop.fPopCalendar(this);return false;" readonly value="2008-7-29"></td>
                  <td height="12" nowrap bgcolor="#b5d6e6" style="padding-right: 25px">内部编号:</td>
                  <td height="12" bgcolor="#EBF4F5"><input name="Source_No" type="text" id="Source_No" style="width: 100%" maxlength="50" value="P_xyz_v0001"></td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td colspan="3" bgcolor="#EBF4F5"><textarea name="KeyWord" style="line-height: 19px; width: 100%; height: 100%; padding-right: 5px; padding-left: 5px">XYZ_业务可行性分析_V0001.doc</textarea> 
                  </td>
                </tr>
                <tr> 
                  ...
                  <td height="20" colspan="3" bgcolor="#EBF4F5" style="padding-top: 0px; padding-bottom: 0px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
						<td><textarea name="UpFile" style="width: 300%; height: 20px; border: 0px; padding-left: 1px; overflow-y: scroll; overflow-x: hidden; background-image: url(../../img/pp.gif); background-repeat: no-repeat; padding-left: 16px; cursor: hand" readonly onDblClick="window.open('../home/?NowAction=attach&Item=UpFile&Value='+this.value,'','width=450,height=350,scrollbars=no,menubar=no,resizable=no,top=120,left=120,status=yes')">1、[upload=doc]F_080729_182544_945_FENGCHI.doc[/upload]DEMO演示_V03.DOC</textarea></td>
