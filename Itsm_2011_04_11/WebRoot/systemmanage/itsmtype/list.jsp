...
<tr bgcolor="#FFFFFF">
			...
			<s:iterator value="ItsmTypelist" var="itsmType">
				<tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#e3f0f7'" onMouseOut="this.bgColor='#FFFFFF'">
					...
					<td align="center">
							...
							<a href="updateInput.action?itsmtypeid=<s:property value="id"/>">修改</a>
					</td>
					<td align="center">
							<img src="../images/del.gif">&nbsp;
							<a href="delete.action?itsmtypeid=<s:property value="id"/>" onclick="javascript:return del()">删除</a>
					</td>
				</tr>
			</s:iterator>
		</table>
