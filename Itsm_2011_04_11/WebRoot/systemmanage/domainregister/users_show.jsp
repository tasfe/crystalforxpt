...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0"  class="tab1">
  ...
  <tr>
    <td colspan="6"><table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#000000">

      <tr align="center">
        <td height="22" width="30%" align="center" bgcolor="#FFFFFF">申请域名||Domain</td>
  ...
  <br>
  <tr>
    <td width="113" height="39">单位负责人：</td>
    <td width="121"><s:property value="domainRegister.unitsLeader"/></td>
    <td width="119">（单位公章）</td>
    <td width="99">申请人签名：</td>
    <td width="83"><s:property value="domainRegister.application"/></td>
    <td width="65"><s:date name="domainRegister.applicationDate"  format="yyyy-MM-dd"/></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="6"><table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#000000">
      ...
      <tr>
        ...
        <td width="34%" bgcolor="#FFFFFF"><s:property value="domainRegister.receiver"/></td>
        <td width="20%" align="center" bgcolor="#FFFFFF">接收日期</td>
        <td width="29%" bgcolor="#FFFFFF"><s:date name="domainRegister.receiveDate"  format="yyyy-MM-dd"/></td>
      </tr>
      <tr>
        <td height="24" align="center" bgcolor="#FFFFFF">完成人</td>
        <td bgcolor="#FFFFFF"><s:property value="domainRegister.completer"/></td>
        <td align="center" bgcolor="#FFFFFF">完成日期</td>
        <td bgcolor="#FFFFFF"><s:date name="domainRegister.completeDate"  format="yyyy-MM-dd"/></td>
      </tr>
    </table></td>
  </tr>
</table>
