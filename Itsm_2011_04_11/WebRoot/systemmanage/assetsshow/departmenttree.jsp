	...
	Ext.onReady(function(){
		...
		var typeTree = new Ext.tree.TreePanel({
			...
			loader: new Ext.tree.TreeLoader({
				dataUrl: "../showAssets/departmenttree.action",
			...
			listeners:{
				click:function (node, e){
					...
					parent.document.getElementById('listFrame').src="qurey.action?assets.usersByChargeId.department.id="+id+"&assets.usersByChargeId.department.name="+node.attributes.showname;
				}
			}
		});
