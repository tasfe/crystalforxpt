...
<table width="98%" cellspacing="1" align="center" bgcolor="#b5d6e6">
 <tr>
 <td align="center" bgcolor="#deebf1" height="22" background="../../images/main20100521_58.gif" class="alllisttitle"><s:property value="ipAddress.id>"/>更新IP地址申请</td>
 </tr>
 <tr>
             ...
             <tr>
               <td valign="top" bgcolor="#EBF4FD"><table cellspacing=0 cellpadding=0 border=0 width="100%" class="zcxx_tab3">
                 <tr>
                   ...
                   <td  height="30" align="left"><s:textfield id="ipAddress.applyIpv4Count" name="ipAddress.applyIpv4Count" /></td>
                   ...
                   <td  height="30" align="left"><s:textfield id="ipAddress.applyIpv6Count" name="ipAddress.applyIpv6Count"/></td>
                   <td><table width="1" border="0" cellspacing="0" cellpadding="0" bgcolor="#C0D6EE" height="99%" align="center">
                     <tr>
                       <td></td>
                     </tr>
                   ...
                   <td  height="30" align="left"><s:textfield id="ipAddress.applyIpPurpose" name="ipAddress.applyIpPurpose" /></td>
                 </tr>
                 <tr>
                   <td height="30" align="right">IP地址使用位置：</td>
                   <td height="30" align="left"><s:textfield id="ipAddress.ipUseRoom" name="ipAddress.ipUseRoom"/></td>
                   <td><table width="1" border="0" cellspacing="0" cellpadding="0" bgcolor="#C0D6EE" height="99%" align="center">
                     <tr>
                       <td></td>
                     </tr>
                   ...
                   <td height="30" align="left"><s:textfield id="ipAddress.unitsFullName" name="ipAddress.unitsFullName"/></td>
                   <td><table width="1" border="0" cellspacing="0" cellpadding="0" bgcolor="#C0D6EE" height="99%" align="center">
                     <tr>
                       <td></td>
                     </tr>
                   ...
                   <td height="30" align="left"><s:textfield id="ipAddress.unitsAddress" name="ipAddress.unitsAddress"/></td>
                 </tr>
                 <tr>
                   <td width="8%" height="30" align="right">单位现有IP地址数量：</td>
                   <td width="16%" height="30" align="left"><s:textfield id="ipAddress.unitsExtentIpCount" name="ipAddress.unitsExtentIpCount"/></td>
                   <td><table width="1" border="0" cellspacing="0" cellpadding="0" bgcolor="#C0D6EE" height="99%" align="center">
                     <tr>
                       <td></td>
                     </tr>
                   ...
                   <td width="16%" height="30" align="left"><s:textfield id="ipAddress.unitsExtentIpPurpose" name="ipAddress.unitsExtentIpPurpose" /></td>
                   <td><table width="1" border="0" cellspacing="0" cellpadding="0" bgcolor="#C0D6EE" height="99%" align="center">
                     <tr>
                       <td></td>
                     </tr>
                   ...
                   <td width="20%" height="30" align="left"><s:textfield id="ipAddress.technicalContact" name="ipAddress.technicalContact" /></td>
                 </tr>
                 <tr>
                   <td width="14%" height="30" align="right">联系电话：</td>
                   <td width="16%" height="30" align="left"><s:textfield id="ipAddress.phone" name="ipAddress.phone"/></td>
                   <td><table width="1" border="0" cellspacing="0" cellpadding="0" bgcolor="#C0D6EE" height="99%" align="center">
                     <tr>
                       <td></td>
                     </tr>
                   ...
                   <td width="16%" height="30" align="left"><s:textfield id="ipAddress.email" name="ipAddress.email"/></td>
                   <td><table width="1" border="0" cellspacing="0" cellpadding="0" bgcolor="#C0D6EE" height="99%" align="center">
                     <tr>
                       <td></td>
                     </tr>
                   ...
                   <td width="20%" height="30" align="left"><input type="text" name="ipAddress.applicationDate" value="<s:date name="ipAddress.applicationDate" format="yyyy-MM-dd"/>"/></td>
                 </tr>
                 <tr>
                   <td width="14%" height="30" align="right">单位负责人：</td>
                   <td width="16%" height="30" align="left"><s:textfield id="ipAddress.unitsLeader" name="ipAddress.unitsLeader" /></td>
                   <td><table width="1" border="0" cellspacing="0" cellpadding="0" bgcolor="#C0D6EE" height="99%" align="center">
                     <tr>
                       <td></td>
                     </tr>
                   ...
                   <td width="16%" height="30" align="left"><s:textfield id="ipAddress.application" name="ipAddress.application"/></td>
                   <td><table width="1" border="0" cellspacing="0" cellpadding="0" bgcolor="#C0D6EE" height="99%" align="center">
                     <tr>
                       <td></td>
                     </tr>
     ...
     <tr>
       <td><table width="99%" align="center" cellpadding="0" cellspacing="0">
         <tr>
           ...
           <td width="24%" valign="bottom" class="alllisttitle" align="center">·在此具体填写申请IP地址原因·</td>
             ...
             <tr>
               <td valign="top" bgcolor="#EBF4FD"><table cellspacing=0 cellpadding=0 border=0 width="100%" class="zcxx_tab3">
                 <tr>
                   ...
                   <td width="84%"  align="left" ><s:textarea id="ipAddress.applyIpCause" name="ipAddress.applyIpCause" style="height:70px;width:100%;"/></td>
