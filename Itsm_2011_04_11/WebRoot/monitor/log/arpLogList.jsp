				...
				<tr>
				  <td valign="top" bgcolor="#FFFFFF">
					...
					<table width="100%" border="0" align="center" cellpadding="2"
							...
							<s:form name="form1" action="queryArpLog" method="post" theme="simple"
								...
								<tr>
									...
									<td align="right" width="8%" nowrap bgcolor="#deebf1">选择类型：</td>
									<td width="8%" bgcolor="#ffffff" style="padding-right: 10px">
										<select id="type" name="type" style="width: 100%; height:18px;" >
										<option>全部</option>
										<option>动态</option>
										<option>静态</option>
										<option>无效</option>
								  ...
								  <table cellspacing="0" cellpadding="0" border="0" width="100%">
									  ...
									  <tr>
										  <td width="100%" height="30" style="padding-top: 10px">
											  <img src="../images/main20100521dot04.gif"><b>ARP日志:</b>&nbsp;
									    </td>
						...
						<tr>
							<td valign="top" colspan="2">
								<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#b5d6e6">
									...
									<th width="3%" height="22" nowrap background="../images/main20100521_58.gif" class="alllisttitle"> 类型</th>
