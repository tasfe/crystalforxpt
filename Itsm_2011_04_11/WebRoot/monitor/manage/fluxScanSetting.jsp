...
function setDefaultValue(){
	 document.getElementById("fluxScanGapTime").value=5;
	 document.getElementById("fluxSwitch").checked=true; 
	 document.getElementById("fluxType").value=0;
...
//提交
function doSubmit(){
	if(document.getElementById("fluxScanGapTime").value==null||document.getElementById("fluxScanGapTime").value==""){
		alert("请选择数据采集间隔时间！");
		return ;
	}
	if(document.getElementById("fluxType").value==null||document.getElementById("fluxType").value==""){
		alert("请选择数据采集类型！");
		return ;
	}
	...
	document.form.action="monitorSystemSettings/saveFluxScanSetting.action"
      		...
      		<dt>选项</dt>
      			<dd id="" >
      			 <table class="STYLE4">
	      			 <tr height=30>
	      			 	<td width=100>
	      			 	 <s:if test="fluxScan.fluxSwitch==0">
					     	 <input type="checkbox" id="fluxSwitch" name="fluxScan.fluxSwitch"  value="1" >
					      </s:if>
					      <s:else>
					      	<input type="checkbox" id="fluxSwitch" name="fluxScan.fluxSwitch"  checked value="1" >
					      </s:else>
					               启用
	      			 	</td>
	      			 	<td width=100>
	      			 		...
	      			 		间隔<s:select 
	      			 			...
	      			 			name="fluxScan.fluxScanGapTime" 
	      			 			value="fluxScan.fluxScanGapTime" 
	      			 			theme="simple" 
	      			 			headerKey="" 
	      			 	...
	      			 	<td width=200>     
					      	采集类型<s:select 
	      			 			id="fluxType"
	      			 			list="#{1:'互联端口',0:'全部端口'}" 
	      			 			name="fluxScan.fluxType" 
	      			 			value="fluxScan.fluxType" 
	      			 			theme="simple" 
	      			 			headerKey="" 
	      			 			headerValue="请选择"></s:select>
	      			  ...
	      			  <tr height=30>
	      			 	<td  colspan=3>
	      			 	 ...
	      			 	 <s:select 
	      			 			id="minuteDataKeep"
	      			 			list="#{7:'一周',30:'一个月'}" 
	      			 			name="fluxScan.minuteDataKeep" 
	      			 			value="fluxScan.minuteDataKeep" 
	      			 			theme="simple" 
	      			 			headerKey="" 
	      			 			headerValue="请选择"></s:select>
	      			 	 小时历史数据保存时长
	      			 	 <s:select 
	      			 			...
	      			 			name="fluxScan.hourDataKeep" 
	      			 			value="fluxScan.hourDataKeep" 
	      			 			theme="simple" 
	      			 			headerKey="" 
	      			 			headerValue="请选择"></s:select>
