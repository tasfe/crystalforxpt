...
--
-- Definition of table `addressbook_manage`
--
...
--
-- Dumping data for table `addressbook_manage`
--

/*!40000 ALTER TABLE `addressbook_manage` DISABLE KEYS */;
/*!40000 ALTER TABLE `addressbook_manage` ENABLE KEYS */;


--
-- Definition of table `assets_base`
--
...
CREATE TABLE `assets_base` (
  ...
  CONSTRAINT `FK_assets_type` FOREIGN KEY (`type_code`) REFERENCES `assets_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_assets_base` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_assets_base_buildlocation` FOREIGN KEY (`buildlocation`) REFERENCES `buildlocation` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_assets_base_itsmtype` FOREIGN KEY (`itsmtype`) REFERENCES `itsm_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_assets_producer` FOREIGN KEY (`produce_id`) REFERENCES `assets_producer` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_assets_state` FOREIGN KEY (`state`) REFERENCES `assets_state` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_assets_support` FOREIGN KEY (`support_id`) REFERENCES `assets_producer` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_assets_users` FOREIGN KEY (`charge_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_department` FOREIGN KEY (`department_code`) REFERENCES `department` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_location` FOREIGN KEY (`place_id`) REFERENCES `location` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `assets_base`
--

/*!40000 ALTER TABLE `assets_base` DISABLE KEYS */;
/*!40000 ALTER TABLE `assets_base` ENABLE KEYS */;


--
-- Definition of table `assets_change`
--
...
CREATE TABLE `assets_change` (
  ...
  CONSTRAINT `FK_assets_change_type` FOREIGN KEY (`change_type`) REFERENCES `assets_state` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_assets_change_user` FOREIGN KEY (`userid`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_assets_change` FOREIGN KEY (`assets_base_id`) REFERENCES `assets_base` (`code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_assets_change_chargeid` FOREIGN KEY (`chargeid`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_assets_change_managers` FOREIGN KEY (`managersid`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_assets_change_receiver` FOREIGN KEY (`receiverid`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `assets_change`
--

/*!40000 ALTER TABLE `assets_change` DISABLE KEYS */;
/*!40000 ALTER TABLE `assets_change` ENABLE KEYS */;


--
-- Definition of table `assets_config`
--
...
CREATE TABLE `assets_config` (
  ...
  CONSTRAINT `FK_assets_config` FOREIGN KEY (`assets_type_id`) REFERENCES `assets_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `assets_config`
--

/*!40000 ALTER TABLE `assets_config` DISABLE KEYS */;
/*!40000 ALTER TABLE `assets_config` ENABLE KEYS */;


--
-- Definition of table `assets_history_state`
--
...
--
-- Dumping data for table `assets_history_state`
--

/*!40000 ALTER TABLE `assets_history_state` DISABLE KEYS */;
/*!40000 ALTER TABLE `assets_history_state` ENABLE KEYS */;


--
-- Definition of table `assets_info`
--
...
CREATE TABLE `assets_info` (
  ...
  CONSTRAINT `FK_assets_info` FOREIGN KEY (`assets_base_id`) REFERENCES `assets_base` (`code`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Definition of table `assets_producer`
--
...
--
-- Dumping data for table `assets_producer`
--

/*!40000 ALTER TABLE `assets_producer` DISABLE KEYS */;
/*!40000 ALTER TABLE `assets_producer` ENABLE KEYS */;


--
-- Definition of table `assets_state`
--
...
--
-- Dumping data for table `assets_state`
--

/*!40000 ALTER TABLE `assets_state` DISABLE KEYS */;
INSERT INTO `assets_state` (`id`,`name`,`sequence`,`remark1`) VALUES 
 (0,'已删除',0,NULL);
/*!40000 ALTER TABLE `assets_state` ENABLE KEYS */;
...
--
-- Definition of table `authority_roleteam`
--
...
--
-- Dumping data for table `authority_roleteam`
--

/*!40000 ALTER TABLE `authority_roleteam` DISABLE KEYS */;
/*!40000 ALTER TABLE `authority_roleteam` ENABLE KEYS */;


--
-- Definition of table `buildlocation`
--
...
--
-- Dumping data for table `buildlocation`
--

/*!40000 ALTER TABLE `buildlocation` DISABLE KEYS */;
INSERT INTO `buildlocation` (`id`,`name`,`pid`,`code`,`allname`) VALUES 
 (1,'存放位置',0,'001',NULL);
/*!40000 ALTER TABLE `buildlocation` ENABLE KEYS */;


--
-- Definition of table `config_record`
--
...
CREATE TABLE `config_record` (
  ...
  CONSTRAINT `FK_config_record` FOREIGN KEY (`assets_type_id`) REFERENCES `assets_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `config_record`
--

/*!40000 ALTER TABLE `config_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `config_record` ENABLE KEYS */;
...
INSERT INTO `customer_type` (`id`,`name`,`value`) VALUES 
 (1,'好友',NULL),
 (2,'朋友',NULL),
 (3,'家人',NULL),
 (4,'新同事',NULL),
...
INSERT INTO `department` (`id`,`pid`,`name`,`code`,`description`) VALUES 
 (1,0,'总部','001','');
...
--
-- Definition of table `document_authority`
--
...
--
-- Dumping data for table `document_authority`
--

/*!40000 ALTER TABLE `document_authority` DISABLE KEYS */;
/*!40000 ALTER TABLE `document_authority` ENABLE KEYS */;


--
-- Definition of table `document_cat`
--
...
/*!40000 ALTER TABLE `document_cat` DISABLE KEYS */;
/*!40000 ALTER TABLE `document_cat` ENABLE KEYS */;


--
-- Definition of table `document_old`
--
...
--
-- Dumping data for table `document_old`
--

/*!40000 ALTER TABLE `document_old` DISABLE KEYS */;
/*!40000 ALTER TABLE `document_old` ENABLE KEYS */;


--
-- Definition of table `domain_register`
--
...
/*!40000 ALTER TABLE `domain_register` DISABLE KEYS */;
/*!40000 ALTER TABLE `domain_register` ENABLE KEYS */;


--
-- Definition of table `error_type`
--
...
--
-- Dumping data for table `formguide`
--

/*!40000 ALTER TABLE `formguide` DISABLE KEYS */;
/*!40000 ALTER TABLE `formguide` ENABLE KEYS */;


--
-- Definition of table `functioncolumn`
--
...
--
-- Dumping data for table `functioncolumn`
--

/*!40000 ALTER TABLE `functioncolumn` DISABLE KEYS */;
/*!40000 ALTER TABLE `functioncolumn` ENABLE KEYS */;
...
--
-- Definition of table `interface_log`
--
...
--
-- Definition of table `ip_address`
--
...
--
-- Definition of table `ip_netcenter`
--
...
--
-- Dumping data for table `ip_netcenter`
--

/*!40000 ALTER TABLE `ip_netcenter` DISABLE KEYS */;
/*!40000 ALTER TABLE `ip_netcenter` ENABLE KEYS */;


--
-- Definition of table `itsm_type`
--
...
--
-- Dumping data for table `itsm_type`
--

/*!40000 ALTER TABLE `itsm_type` DISABLE KEYS */;
INSERT INTO `itsm_type` (`id`,`name`,`description`,`pid`,`code`) VALUES 
 (1,'运维类别',NULL,0,'001'),
 (5,'网络设备',NULL,1,'001001'),
 (6,'交换机',NULL,5,'001001005'),
 (7,'路由器',NULL,5,'001001002'),
 (8,'交换机+路由器',NULL,5,'001001003'),
 (9,'SNMP主机',NULL,5,'001001006'),
 (10,'入网计算机',NULL,1,'001002');
/*!40000 ALTER TABLE `itsm_type` ENABLE KEYS */;
...
--
-- Definition of table `knowledge_base`
--
...
--
-- Definition of table `ldapadapter`
--
...
--
-- Dumping data for table `ldapadapter`
--

/*!40000 ALTER TABLE `ldapadapter` DISABLE KEYS */;
/*!40000 ALTER TABLE `ldapadapter` ENABLE KEYS */;
...
INSERT INTO `location` (`id`,`name`,`content`,`pid`,`code`,`location_sc`) VALUES 
 (1,'所有区域','',0,'00','all');
...
INSERT INTO `menu` (`ID`,`roletype`,`ParentID`,`Name`,`Type`,`Module`,`URL`,`Visiable`,`Icon`,`OrderFlag`,`PrivField`,`Prop1`,`Prop2`,`Memo`,`AddTime`,`AddUser`,`ModifyTime`,`ModifyUser`) VALUES 
 (3,'1',0,'办公申请','1',2,NULL,'Y','images/icons/icon039a1.gif',7,NULL,NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (4,'1:2',0,'IT资产管理','1',2,NULL,'Y','images/icons/treeicon10.gif',1,'',NULL,NULL,NULL,'2010-11-11 09:41:00','admin',NULL,NULL),
 (5,'1',4,'IT资产管理','2',2,'assets/list.action','Y','images/icons/treeicon11.gif',1,'changes:批量变更,change:变更,changeselect:变更查询,export:导出,add:新建,update:修改,delete:删除,query:查看',NULL,NULL,NULL,'2010-11-11 09:41:00','admin',NULL,NULL),
 (6,'1',4,'资产属性配置','2',2,'assetsconfig/main.action','Y','images/icons/icon402a4.gif',3,'config:配置,update:修改,delete:删除',NULL,NULL,NULL,'2010-11-11 09:41:00','admin',NULL,NULL),
 (7,'1',4,'资产类别管理','2',2,'assetstype/main.action','Y','images/icons/icon047a12.gif',4,'add:新建,update:修改,delete:删除',NULL,NULL,NULL,'2010-11-11 09:41:00','admin',NULL,NULL),
 (8,'1',4,'资产状态管理','2',2,'assetsstate/list.action','Y','images/icons/icon041a15.gif',5,'add:新建,update:修改,delete:删除',NULL,NULL,NULL,'2010-11-11 09:41:00','admin',NULL,NULL),
 (9,'1',4,'供应厂商管理','2',2,'producer/list.action','Y','images/icons/icon041a6.gif',6,'add:新建,update:修改,delete:删除',NULL,NULL,NULL,'2010-11-11 09:41:00','admin',NULL,NULL),
 (10,'1:2',4,'资产信息统计','2',2,'assets/statistic.action','Y','images/icons/icon032a12.gif',7,NULL,NULL,NULL,NULL,'2010-11-11 09:41:00','admin',NULL,NULL),
 (11,'1:2',4,'资产信息查看','2',2,'showAssets/main.action','Y','images/icons/icon032a15.gif',8,NULL,NULL,NULL,NULL,'2010-11-11 09:41:00','admin',NULL,NULL),
 (12,'1',4,'资产质保查询','2',2,'assets/quality.action','Y','images/icons/icon031a9.gif',9,NULL,NULL,NULL,NULL,'2010-11-11 09:41:00','admin',NULL,NULL),
 (13,'1',4,'资产批量导入','2',2,'systemmanage/assets/importassets.jsp','Y','images/icons/icon026a2.gif',10,'import:导入,download:下载',NULL,NULL,NULL,'2010-11-11 09:41:00','admin',NULL,NULL),
 (15,'1:2',0,'事件管理','1',2,NULL,'Y','images/icons/icon012a5.gif',1,NULL,NULL,NULL,NULL,'2010-11-12 08:52:00','yhm',NULL,NULL),
 (16,'1',15,'提交请求','2',2,'engineerrequest/init.action','Y','images/icons/icon018a4.gif',2,'',NULL,NULL,NULL,'2010-11-12 08:52:00','yhm',NULL,NULL),
 (17,'1:2',15,'跟踪请求处理情况','2',2,'engineertrace/tracelist.action','Y','images/icons/icon018a8.gif',3,'select:查询,intervene:干预,distribute:指派任务',NULL,NULL,NULL,'2010-11-12 08:52:00','yhm',NULL,NULL),
 (18,'1:2',15,'服务请求历史','2',2,'engineerrequesthistory/requestlist.action','Y','images/icons/icon022a1.gif',4,'',NULL,NULL,NULL,'2010-11-12 08:52:00','yhm',NULL,NULL),
 (20,'1:2',0,'资源管理','1',2,NULL,'Y','images/icons/icon038a4.gif',1,NULL,NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (21,'1',20,'日志管理','2',2,'worklog/myquery.action','Y','images/icons/icon038a4.gif',2,'add:新建,select:搜索,update:修改,delete:删除,query:查看',NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (22,'1:2',20,'日志查询','2',2,'worklog/main.action','Y','images/icons/icon038a4.gif',3,'select:搜索,query:查看',NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (23,'1:2',20,'日志排行','2',2,'worklog/hot.action','Y','images/icons/icon038a4.gif',4,NULL,NULL,NULL,NULL,'2010-11-12 00:00:00','admin',NULL,NULL),
 (24,'1:2',20,'知识库管理','2',2,'knowledgebase/list.action','Y','images/icons/icon038a4.gif',5,'add:新建,select:搜索,update:修改,delete:删除,query:查看',NULL,NULL,NULL,'2010-11-11 00:00:00','admin',NULL,NULL),
 (25,'1',20,'文档管理','2',2,'document/main.action?pid=0','Y','images/icons/icon038a4.gif',6,'add:新建,select:搜索,update:修改,delete:删除,query:查看,history:历史',NULL,NULL,NULL,'2010-11-11 00:00:00','admin',NULL,NULL),
 (30,'1',0,'通讯录管理','1',2,NULL,'Y','images/icons/icon037a6.gif',1,NULL,NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (31,'1',30,'公共通讯录','2',2,'AddressBookManage/main.action?pid=0','Y','images/icons/icon037a6.gif',2,'add:新建,search:查询,update:修改,delete:删除,detail:查看,export:导出',NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (32,'1',30,'个人通讯录','2',2,'AddressBookManage/mainContact.action','Y','images/icons/icon037a6.gif',3,'add:新建,search:查询,update:修改,delete:删除,detail:查看',NULL,NULL,NULL,'2010-11-15 11:00:00','admin',NULL,NULL),
 (33,'1',30,'通讯录导入','2',2,'AddressBookManage/addressImport.action','Y','images/icons/icon037a6.gif',4,'import:导入,downloads:模板下载',NULL,NULL,NULL,'2010-11-15 12:00:00','admin',NULL,NULL),
 (40,'1:2',0,'计划任务管理','1',2,'','Y','images/icons/icon019a4.gif',1,NULL,NULL,NULL,NULL,'2010-11-12 15:00:00','yhm',NULL,NULL),
 (41,'1:2',40,'添加新任务','2',2,'schedualedtask/add.action','Y','images/icons/icon020a4.gif',2,NULL,NULL,NULL,NULL,'2010-11-12 15:00:00','yhm',NULL,NULL),
 (42,'1:2',40,'查看全部任务','2',2,'schedualedtask/list.action','Y','images/icons/icon005a15.gif',3,'update:修改,delete:删除',NULL,NULL,NULL,'2010-11-12 15:00:00','yhm',NULL,NULL),
 (43,'1:2',40,'工作日历','2',2,'schedualedtask/calendar.action','Y','images/icons/icon010a12.gif',4,NULL,NULL,NULL,NULL,'2010-11-12 15:00:00','yhm',NULL,NULL),
 (44,'1:2',40,'按周查看任务','2',2,'schedualedtask/week.action','Y','images/icons/icon045a15.gif',5,NULL,NULL,NULL,NULL,'2010-11-12 15:00:00','yhm',NULL,NULL),
 (50,'3',0,'提交新请求（用户界面）','1',2,'userrequest/init.action','Y','images/icons/icon031a9.gif',1,NULL,NULL,NULL,NULL,'2010-11-15 10:00:00','yhm',NULL,NULL),
 (51,'3',0,'跟踪服务进度（用户界面）','1',2,'usertrace/tracelist.action','Y','images/icons/icon003a5.gif',2,NULL,NULL,NULL,NULL,'2010-11-12 00:00:00','yhm',NULL,NULL),
 (52,'3',0,'查看历史记录（用户界面）','1',2,'userrequesthistory/tracelist.action?state=5','Y','images/icons/icon012a6.gif',3,NULL,NULL,NULL,NULL,'2010-11-12 00:00:00','yhm',NULL,NULL),
 (53,'3',0,'知识库检索（用户界面）','1',2,'knowledgebase/user.action','Y','images/icons/icon048a6.gif',4,'select:搜索',NULL,NULL,NULL,'2010-11-12 00:00:00','yhm',NULL,NULL),
 (54,'3',0,'论坛交流（用户界面）','1',2,'bbs/index.jsp','Y','images/icons/icon038a4.gif',5,NULL,NULL,NULL,NULL,'2010-11-12 00:00:00','yhm',NULL,NULL),
 (55,'3',0,'系统公告（用户界面）','1',2,'SystemNotice/findNowNotices.action','Y','images/icons/icon020a4.gif',6,NULL,NULL,NULL,NULL,'2010-11-12 00:00:00','yhm',NULL,NULL),
 (56,'3',0,'退出系统（用户界面）','1',2,'SystemNotice/findNowNotices.action','Y','images/icons/icon037a6.gif',7,NULL,NULL,NULL,NULL,'2010-11-12 00:00:00','yhm',NULL,NULL),
 (57,'3',0,'个人资料配置(用户界面)','1',2,'user/personaldata.action','Y','images/icons/icon038a4.gif',15,NULL,NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (60,'1',0,'监控管理','1',2,NULL,'Y','images/icons/treeicon10.gif',1,NULL,NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (61,'1',60,'设备管理','2',2,'monitorDevice/deviceList.action','Y','images/icons/icon008a1.gif',1,'add:添加,search:搜索,delete:删除,query:查看,update:修改,port:设备端口, statistics:统计',NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (62,'1',60,'分区管理','2',2,'monitor/subnet/subnetList.jsp','Y','images/icons/icon042a1.gif',2,'add:新建,update:修改,delete:删除,topology:拓扑',NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (63,'1',60,'入网计算机','2',2,'monitorComputer/computerList.action','Y','images/icons/icon2.gif',3,'scan:扫描',NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (64,'1',60,'Top-N','2',2,'monitorTopN/listAll.action','Y','images/icons/icon031a9.gif',4,NULL,NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (65,'1',60,'报警','2',2,'monitorAlert/listAll.action','Y','images/icons/icon003a5.gif',5,NULL,NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (67,'1',60,'管理','2',2,'monitor/manage/settings.jsp','Y','images/icons/icon038a4.gif',7,NULL,NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (70,'4',0,'系统管理','1',2,'','Y','images/icons/icon012a6.gif',1,NULL,NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (72,'4',70,'区域管理','2',2,'location/main.action?pid=1','Y','images/icons/icon038a4.gif',3,'add:新建,delete:删除,update:修改',NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (74,'4',70,'部门管理','2',2,'department/main.action?pid=1','Y','images/icons/icon026a19.gif',5,'add:新建,search:查询,update:修改,delete:删除,detail:查看,export:导出',NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (75,'0',3,'日程管理','2',2,NULL,'Y','images/icons/icon020a4.gif',6,NULL,NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (76,'1',3,'IP申请管理','2',2,'','Y','images/icons/icon047a1.gif',7,'',NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (77,'1',3,'域名申请管理','2',2,'','Y','images/icons/icon046a17.gif',8,'',NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (78,'4',70,'用户管理','2',2,NULL,'Y','images/icons/icon025a11.gif',9,NULL,NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (80,'4',70,'类别管理','2',2,NULL,'Y','images/icons/icon400a19.gif',11,NULL,NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (81,'1',75,'预约登记','3',2,'schedule/add.action','Y','images/icons/icon020a4.gif',12,NULL,NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (82,'1',75,'预约查询','3',2,'schedule/list.action','Y ','images/icons/icon020a4.gif',13,'add:新建,search:搜索,update:修改,delete:删除,detail:查看,reset:重置',NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (83,'1',75,'我的日程','3',2,'schedule/my.action','Y','images/icons/icon020a4.gif',14,'add:新建,search:搜索,update:修改,delete:删除,detail:查看,reset:重置',NULL,NULL,NULL,'2010-11-12 10:00:00','admin',NULL,NULL),
 (85,'4',78,'用户资料','3',2,'user/list.action','Y ','images/icons/icon025a11.gif',16,'add:新建,search:搜索,update:修改,delete:删除,detail:查看,reset:重置',NULL,NULL,NULL,'2010-11-14 10:00:00','admin',NULL,NULL),
 (86,'4',78,'角色权限配置','3',2,'role/main.action','Y','images/icons/icon025a1.gif',19,'',NULL,NULL,NULL,'2010-11-14 10:00:00','admin',NULL,NULL),
 (88,'4',78,'用户角色','3',2,'role/list.action','Y','images/icons/icon025a8.gif',17,'add:新建,search:搜索,update:修改,delete:删除,detail:查看,reset:重置',NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (89,'4',78,'工程师分组','3',2,'engineer/list.action','Y','images/icons/icon021a12.gif',20,'add:新建,search:搜索,update:修改,delete:删除,detail:查看,reset:重置',NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (90,'4',80,'事件及服务类别','3',2,'serviceCategory/main.action?type=1','Y ','images/icons/icon400a14.gif',21,NULL,NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (91,'4',80,'计划任务类别','3',2,'serviceCategory/main.action?type=2','Y','images/icons/icon400a14.gif',22,NULL,NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (95,'4',80,'项目类别','3',2,'serviceCategory/main.action?type=4','Y','images/icons/icon400a14.gif',26,NULL,NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (96,'4',80,'项目任务类别','3',2,'serviceCategory/list.action?type=5','Y ','images/icons/icon400a14.gif',27,NULL,NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (97,'4',70,'系统公告','2',2,'SystemNotice/listSystemNotice.action','Y','images/icons/icon_board.gif',28,'add:新建新公告,search:搜索,update:修改,delete:删除,detail:查看,reset:重置,noticecheck:通知查看,addpersonal:个人通知发布',NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (98,'4',80,'文档库目录','3',2,'documentCat/main.action?type=4','Y','images/icons/icon_magazaine.gif',25,'add:新建,update:修改,delete:删除',NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (99,'0',76,'IP列表查询','3',2,'ipaddress/list.action','Y','images/icons/icon007a12.gif',29,'add:新建,update:修改,delete:删除,approve:待审批,reset:重置,search:查询,detail:查看,print:打印,export:导出',NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (100,'0',76,'IP用户申请','3',2,'ipaddress/user_saveInput.action','Y','images/icons/icon007a12.gif',30,NULL,NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (101,'0',76,'IP用户查询','3',2,'ipaddress/user_list.action','Y ','images/icons/icon007a12.gif',31,'add:新建,update:修改,delete:删除,search:搜索,reset:重置,detail:查看',NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (102,'1',77,'域名列表查询','3',2,'domainregister/list.action','Y','images/icons/icon039a1.gif',32,'add:新建,update:修改,delete:删除,approve:待审批,reset:重置,search:查询,detail:查看,print:打印,export:导出',NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (103,'1',77,'域名用户申请','3',2,'domainregister/user_saveInput.action','Y','images/icons/icon039a1.gif',33,NULL,NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (104,'1',77,'域名用户查询','3',2,'domainregister/user_list.action','Y','images/icons/icon039a1.gif',34,'add:新建,update:修改,delete:删除,search:搜索,reset:重置,detail:查看',NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (105,'1',4,'资产批量入库','2',2,'assets/batch.action','Y','images/icons/icon047a2.gif',2,NULL,NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (106,'4',70,'任务分配机制','2',0,'taskallocation/list.action','Y','images/icons/icon007a12.gif',5,NULL,NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (107,'1',4,'资产位置管理','2',2,'buildlocation/main.action','Y','images/icons/icon007a12.gif',11,NULL,NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (108,'1',4,'运维类别管理','2',2,'itsmtype/main.action','Y','images/icons/icon007a12.gif',12,NULL,NULL,NULL,NULL,'2010-11-15 10:00:00','admin',NULL,NULL),
 (109,'4',78,'角色组别管理','3',2,'roleGroup/main.action','Y',NULL,23,'add:新建,update:修改,delete:删除,search:搜索,reset:重置,detail:查看',NULL,NULL,NULL,'2010-02-25 10:00:00','admin',NULL,NULL),
 (110,'4',70,'系统信息','2',2,'license/getInfo.action','Y',NULL,29,NULL,NULL,NULL,NULL,'2010-02-25 10:00:00','admin',NULL,NULL);
...
--
-- Definition of table `monitor_access_log`
--
...
--
-- Dumping data for table `monitor_access_log`
--

/*!40000 ALTER TABLE `monitor_access_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_access_log` ENABLE KEYS */;


--
-- Definition of table `monitor_alert`
--
...
--
-- Dumping data for table `monitor_alert`
--

/*!40000 ALTER TABLE `monitor_alert` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_alert` ENABLE KEYS */;


--
-- Definition of table `monitor_alert_policy`
--
...
--
-- Dumping data for table `monitor_alert_policy`
--

/*!40000 ALTER TABLE `monitor_alert_policy` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_alert_policy` ENABLE KEYS */;


--
-- Definition of table `monitor_alert_smalltype`
--
...
--
-- Dumping data for table `monitor_alert_smalltype`
--

/*!40000 ALTER TABLE `monitor_alert_smalltype` DISABLE KEYS */;
INSERT INTO `monitor_alert_smalltype` (`CODE`,`NAME`,`PCODE`,`ISUSE`,`LEVEL`,`DESCRIPTION`) VALUES 
 (1,'设备无反应',1,1,1,'报警说明：通过SNMP协议向目标设备发送请求，没有得到回应.<br/>产生原因：<br/>1．可能是SNMP通讯字（Community）配置不正确；<br/>2．可能是本机的网络设置出现问题导致不能连接到网络；<br/>3．可能是本机与目标设备之间的物理链路不通；<br/>4．可能是目标设备故障、断电或是没有启动SNMP服务.<br/>解决办法：针对以上4种原因逐个排查。'),
 (2,'服务器无反应',1,1,1,'报警说明：通过SNMP协议向目标服务器发送请求，没有得到回应。<br/>产生原因：1．可能是SNMP通讯字（Community）配置不正确；<br/>2．可能是本机的网络设置出现问题导致不能连接到网络；<br/>3．可能是本机与目标服务器之间的物理链路不通；<br/>4．可能是目标服务器故障、断电或是没有启动SNMP服务。<br/>解决办法：针对以上4种原因逐个排查。\r\n'),
 (3,'服务无反应',1,1,1,'报警说明：通过TCP协议向目标服务的端口发送连接请求，没有得到回应。<br/>产生原因：<br/>1．可能是本机的网络设置出现问题导致不能连接到网络；<br/>2．可能是本机与目标服务所在的服务器之间的物理链路不通；<br/>3．可能是目标服务器故障或者断电；<br/>4．可能是目标服务没有正常运行或已被关闭，或是已经转到了其它的端口。<br/>解决办法：针对以上4种原因逐个排查。\r\n'),
 (4,'新计算机',2,1,3,'报警说明：扫描网络内计算机后，对比计算机档案表，出现了新增的MAC记录。<br/>产生原因：<br/>1．有新计算机连接到网络中；<br/>2．原有计算机更换或新增了网卡。 \r\n'),
 (5,'IP地址改变',2,1,3,'报警说明：扫描网络内计算机后，发现存在某个MAC更换了原有的IP地址。<br/>产生原因：<br/>1．网络使用DHCP协议动态分配IP，某个台主机本次登录后被重新分配了新的IP地址；<br/>2．用户自己修改了原来的静态IP地址。\r\n'),
 (6,'上连设备改变',2,1,3,'报警说明：扫描网络内计算机后，发现存在某台主机更换了网络位置，通过另外一台交互设备来接入网络.<br/>\r\n产生原因：<br/>1．目标主机可能是便携设备，可以轻易的通过不同交换设备接入到网络;<br/>2．网络内更换了新的交换设备.'),
 (7,'计算机名改变',2,1,3,'报警说明：扫描网络内计算机后，发现存在某台主机修改了计算机名。'),
 (8,'域或组改变',2,1,3,'报警说明：扫描网络内计算机后，发现存在某台主机修改了域或组。'),
 (9,'登录名改变',2,1,3,'报警说明：扫描网络内计算机后，发现存在某台主机更换了登录账号。'),
 (10,'CPU占用率超过阈值',3,1,2,'报警说明：当设备/服务器的CPU连续多次监测结果超过了用户指定的CPU阈值，产生报警。<br/>产生原因：网络线路负载高，或者网络中存在广播风暴可能造成设备的CPU过高<br/>解决办法：可查询设备/服务器的CPU占用率超过阈值记录。'),
 (11,'接口流量超过阈值',3,1,2,'报警说明：当设备接口的流量/服务器网卡流量连续多次监测结果超过了用户指定的流量阈值，产生报警。<br/>产生原因：P2P下载、广播风暴、在线视频可能造成流量超过阈值。<br/>解决办法：可查询设备接口的流量/服务器网卡流量超过阈值的记录。\r\n'),
 (12,'温度超过阈值',3,1,2,'报警说明：当温度监控设备连续多次监测结果超过了用户指定的温度阈值，产生报警。<br/>产生原因：<br/>解决办法：可查询温度监控设备温度超过阈值的记录。'),
 (13,'冷启动',4,1,3,'报警说明：当设备/服务器配置了SNMP TRAP并制定网管机接收TRAP，设备/服务器进行冷启动操作时会产生报警。<br/>产生原因：<br/>解决办法：可查询设备/服务器的冷启动的记录\r\n'),
 (14,'热启动',4,1,3,'报警说明：当设备/服务器配置了SNMP TRAP并制定网管机接收TRAP，设备/服务器进行热启动操作时会产生报警。<br/>产生原因：<br/>解决办法：可查询设备/服务器的热启动的记录。\r\n'),
 (15,'接口上线',4,1,3,'报警说明：当设备/服务器配置了SNMP TRAP并制定网管机接收TRAP，设备/服务器的接口状态由下线变为上线时会产生报警。<br/>产生原因：<br/>解决办法：可查询设备/服务器的接口上线的记录。\r\n'),
 (16,'接口下线',4,1,3,'报警说明：当设备/服务器配置了SNMP TRAP并制定网管机接收TRAP，设备/服务器的接口状态由上线变为下线时会产生报警。<br/>产生原因：<br/>解决办法：可查询设备/服务器的接口下线的记录。\r\n'),
 (17,'ARP报警',5,1,3,'报警说明：扫描交换机的ARP表进行分析，出现一个MAC对应多个IP时，从入网计算机表查找此MAC，如果能找到则产生报警。<br/>产生原因：产生报警的入网计算机中病毒，或者安装了某些软件导致其不停申请和抢占IP，致使同网段其它计算机无法获取IP。<br/>解决办法：根据报警的入网计算机对应的上连设备和接口，定位计算机所在位置，断开其网网络连接，并责令计算机负责人进行问题排查。\r\n'),
 (18,'SYSLOG',5,1,3,NULL),
 (19,'接口改变',2,1,3,'报警说明：扫描网络内计算机后，发现存在某台主机更换了网络位置，通过同一台交互设备的另一个接口来接入网络。'),
 (20,'设备恢复',1,1,4,'报警说明：从“设备无反应”故障中恢复到正常状态，表明故障已经排除。'),
 (21,'服务器恢复',1,1,4,'报警说明：从“服务器无反应”故障中恢复到正常状态，表明故障已经排除。'),
 (22,'服务恢复',1,1,4,'报警说明：从“服务无反应”故障中恢复到正常状态，表明本机又能够与该服务建立起TCP连接。'),
 (23,'CPU占用率恢复正常',3,1,5,'报警说明：通过SNMP协议向目标服务器发送请求，没有得到回应。<br/>产生原因：<br/>1．可能是SNMP通讯字（Community）配置不正确；<br/>2．可能是本机的网络设置出现问题导致不能连接到网络；<br/>3．可能是本机与目标服务器之间的物理链路不通；<br/>4．可能是目标服务器故障、断电或是没有启动SNMP服务。<br/>解决办法：针对以上4种原因逐个排查。\r\n'),
 (24,'接口流量恢复正常',3,1,5,'报警说明：当设备接口的流量/服务器网卡流量由超过指定流量阈值转变为低于指定流量阈值，产生报警。<br/>产生原因：<br/>解决办法：可查询设备接口的流量/服务器网卡流量恢复正常的记录。\r\n'),
 (25,'温度恢复正常',3,1,5,'报警说明：当温度监控设备由超过指定温度阈值转变为低于指定温度阈值，产生报警。<br/>产生原因：<br/>解决办法：可查询温度监控设备温度恢复正常的记录\r\n'),
 (26,'进程不存在',1,1,1,'报警说明：通过SNMP协议向目标进程所在的服务器发送请求，没有得到回应或者得到回应但回应内容表明该进程已不存在。<br/>产生原因：<br/>1．可能是SNMP通讯字（Community）配置不正确；<br/>2．可能是本机的网络设置出现问题导致不能连接到网络；<br/>3．可能是本机与目标进程所在的服务器之间的物理链路不通；<br/>4．可能是目标服务器故障、断电或是没有启动SNMP服务；<br/>5．可能是目标进程已被关闭或自行退出。<br/>解决办法：针对以上5种原因逐个排查。\r\n'),
 (27,'进程恢复',1,1,4,'报警说明：从“进程不存在”故障中恢复到正常状态，表明本机又能够检测到该进程了。'),
 (28,'关键接口异常',1,1,1,'报警说明：通过SNMP协议向目标接口所在的设备发送请求，没有得到回应或者得到回应但回应内容表明该接口已下线或被关闭。<br/>产生原因：<br/>1．可能是SNMP通讯字（Community）配置不正确；<br/>2．可能是本机的网络设置出现问题导致不能连接到网络；<br/>3．可能是本机与目接口所在设备之间的物理链路不通；<br/>4．可能是目标设备故障、断电或是没有启动SNMP服务；<br/>5．可能是目标接口已被关闭或下线。<br/>解决办法：针对以上5种原因逐个排查。\r\n'),
 (29,'关键接口恢复',4,1,4,'报警说明：从“关键接口异常”故障中恢复到正常状态，表明本机又能够检测到该接口处于上线状态了。'),
 (30,'URL监测异常',1,1,1,'报警说明：通过HTTP协议或HTTPS向目标URL的指定端口发送连接请求，请求超时或返回结果异常。<br/>产生原因：<br/>1．可能是本机的网络设置出现问题导致不能连接到网络；<br/>2．可能是本机与目标服务所在的服务器之间的物理链路不通；<br/>3．可能是目标服务器故障或者断电；<br/>4．可能是目标服务没有正常运行或已被关闭，或是已经转到了其它的端口；<br/>5．可能是网络繁忙导致页面响应迟缓；<br/>6．可能是目标页面中包含了不应该有的关键词，或者是没有包含应该存在的关键词。<br/>解决办法：针对以上6种原因逐个排查。\r\n'),
 (31,'URL监测恢复正常',1,1,1,'报警说明：从“URL监测异常”故障中恢复到正常状态，表明本机又能够正常连接到目标页面了。'),
 (32,'Ping操作无响应',1,1,1,'报警说明：通过Ping操作向目标设备发送请求，没有得到回应。<br/>产生原因：<br/>1．可能是本机与目标设备之间的物理链路不通；<br/>2．可能是目标机器设置了防火墙，禁止了对Ping的响应；<br/>3．可能是目标机器没有开机、断电或出现故障。<br/>解决办法：针对以上3种原因逐个排查。\r\n'),
 (33,'Ping响应恢复',4,1,1,'报警说明：通过Ping操作向目标设备发送请求，响应恢复正常。\n');
/*!40000 ALTER TABLE `monitor_alert_smalltype` ENABLE KEYS */;


--
-- Definition of table `monitor_alert_type`
--
...
--
-- Dumping data for table `monitor_alert_type`
--

/*!40000 ALTER TABLE `monitor_alert_type` DISABLE KEYS */;
INSERT INTO `monitor_alert_type` (`CODE`,`NAME`,`ISUSE`) VALUES 
 (1,'故障报警',1),
 (2,'接入报警',1),
 (3,'阈值超过',1),
 (4,'SNMPTRAP',1),
 (5,'其它报警',1);
/*!40000 ALTER TABLE `monitor_alert_type` ENABLE KEYS */;


--
-- Definition of table `monitor_arp_alert_white_mac`
--
...
--
-- Dumping data for table `monitor_arp_alert_white_mac`
--

/*!40000 ALTER TABLE `monitor_arp_alert_white_mac` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_arp_alert_white_mac` ENABLE KEYS */;


--
-- Definition of table `monitor_arp_log`
--
...
--
-- Dumping data for table `monitor_arp_log`
--

/*!40000 ALTER TABLE `monitor_arp_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_arp_log` ENABLE KEYS */;


--
-- Definition of table `monitor_building`
--
...
--
-- Dumping data for table `monitor_building`
--

/*!40000 ALTER TABLE `monitor_building` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_building` ENABLE KEYS */;


--
-- Definition of table `monitor_building_zone`
--
...
--
-- Dumping data for table `monitor_building_zone`
--

/*!40000 ALTER TABLE `monitor_building_zone` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_building_zone` ENABLE KEYS */;


--
-- Definition of table `monitor_computer`
--
...
--
-- Dumping data for table `monitor_computer`
--

/*!40000 ALTER TABLE `monitor_computer` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_computer` ENABLE KEYS */;


--
-- Definition of table `monitor_cpu_data`
--
...
--
-- Dumping data for table `monitor_cpu_data`
--

/*!40000 ALTER TABLE `monitor_cpu_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_cpu_data` ENABLE KEYS */;


--
-- Definition of table `monitor_cpu_data_day`
--
...
--
-- Dumping data for table `monitor_cpu_data_day`
--

/*!40000 ALTER TABLE `monitor_cpu_data_day` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_cpu_data_day` ENABLE KEYS */;


--
-- Definition of table `monitor_cpu_data_hour`
--
...
--
-- Dumping data for table `monitor_cpu_data_hour`
--

/*!40000 ALTER TABLE `monitor_cpu_data_hour` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_cpu_data_hour` ENABLE KEYS */;


--
-- Definition of table `monitor_department`
--
...
--
-- Dumping data for table `monitor_department`
--

/*!40000 ALTER TABLE `monitor_department` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_department` ENABLE KEYS */;


--
-- Definition of table `monitor_device`
--
...
--
-- Dumping data for table `monitor_device`
--

/*!40000 ALTER TABLE `monitor_device` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_device` ENABLE KEYS */;


--
-- Definition of table `monitor_device_type`
--
...
--
-- Dumping data for table `monitor_device_type`
--

/*!40000 ALTER TABLE `monitor_device_type` DISABLE KEYS */;
INSERT INTO `monitor_device_type` (`CODE`,`NAME`,`ISUSE`,`ICON`) VALUES 
 (1,'交换',1,'switch'),
 (2,'路由',1,'router'),
 (3,'交换+路由',1,'router'),
 (4,'SNMP主机',1,'server'),
 (5,'AP控制器',1,'controller'),
 (6,'温湿度监控设备',1,'akcp'),
 (20,'虚拟设备',1,'virtual ');
/*!40000 ALTER TABLE `monitor_device_type` ENABLE KEYS */;


--
-- Definition of table `monitor_interface_cache`
--
...
--
-- Dumping data for table `monitor_interface_cache`
--

/*!40000 ALTER TABLE `monitor_interface_cache` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_interface_cache` ENABLE KEYS */;


--
-- Definition of table `monitor_key_interface`
--
...
--
-- Dumping data for table `monitor_key_interface`
--

/*!40000 ALTER TABLE `monitor_key_interface` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_key_interface` ENABLE KEYS */;


--
-- Definition of table `monitor_linkport`
--
...
--
-- Dumping data for table `monitor_linkport`
--

/*!40000 ALTER TABLE `monitor_linkport` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_linkport` ENABLE KEYS */;


--
-- Definition of table `monitor_mac_info`
--
...
--
-- Dumping data for table `monitor_mac_info`
--

/*!40000 ALTER TABLE `monitor_mac_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_mac_info` ENABLE KEYS */;


--
-- Definition of table `monitor_old_device`
--
...
--
-- Dumping data for table `monitor_old_device`
--

/*!40000 ALTER TABLE `monitor_old_device` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_old_device` ENABLE KEYS */;


--
-- Definition of table `monitor_old_linkport`
--
...
--
-- Dumping data for table `monitor_old_linkport`
--

/*!40000 ALTER TABLE `monitor_old_linkport` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_old_linkport` ENABLE KEYS */;


--
-- Definition of table `monitor_ping_dest`
--
...
CREATE TABLE `monitor_ping_dest` (
  ...
  `MINISTRY` varchar(64) default NULL,
  ...
  `ASSETS_NO` varchar(32) default NULL,
  `DISK_NO` varchar(128) default NULL,
  `NOTE` varchar(500) default NULL,
  `IS_RUN` tinyint(1) default NULL,
  `FLUSH_TIME` timestamp NOT NULL default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP,
  PRIMARY KEY  (`ID`),
  KEY `FK_PINGDEST_REGION` (`REGION`),
  KEY `FK_PING_DEST_TYPE` (`HOST_TYPE`),
  CONSTRAINT `FK_PING_DEST_TYPE` FOREIGN KEY (`HOST_TYPE`) REFERENCES `monitor_ping_dest_type` (`ID`),
  CONSTRAINT `FK_PINGDEST_REGION` FOREIGN KEY (`REGION`) REFERENCES `monitor_ping_region` (`ID`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `monitor_ping_dest`
--

/*!40000 ALTER TABLE `monitor_ping_dest` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_ping_dest` ENABLE KEYS */;


--
-- Definition of table `monitor_ping_dest_type`
--
...
--
-- Dumping data for table `monitor_ping_dest_type`
--

/*!40000 ALTER TABLE `monitor_ping_dest_type` DISABLE KEYS */;
INSERT INTO `monitor_ping_dest_type` (`ID`,`NAME`,`ICON_CONN`,`ICON_DISCONN`,`ICON_FORBID`,`NOTE`) VALUES 
 (1,'服务器','dest_server_conn.png','dest_server_disconn.png','dest_server_forbid.png',''),
 (2,'工作站','dest_workstation_conn.png','dest_workstation_disconn.png','dest_workstation_forbid.png',''),
 (3,'普通PC','dest_pc_conn.png','dest_pc_disconn.png','dest_pc_forbid.png',''),
 (4,'网络设备','dest_device_conn.png','dest_device_disconn.png','dest_device_forbid.png',''),
 (5,'其它','dest_others_conn.png','dest_others_disconn.png','dest_others_forbid.png','');
/*!40000 ALTER TABLE `monitor_ping_dest_type` ENABLE KEYS */;


--
-- Definition of table `monitor_ping_region`
--
...
CREATE TABLE `monitor_ping_region` (
  ...
  PRIMARY KEY  (`ID`),
  KEY `FK_PINGTYPE_ALERTPOLICY` (`POLICY_ID`),
  KEY `FK_PING_REGION_GROUP` (`GROUP_ID`),
  CONSTRAINT `FK_PING_REGION_GROUP` FOREIGN KEY (`GROUP_ID`) REFERENCES `monitor_ping_region_group` (`ID`),
  CONSTRAINT `FK_PINGTYPE_ALERTPOLICY` FOREIGN KEY (`POLICY_ID`) REFERENCES `monitor_alert_policy` (`ID`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `monitor_ping_region`
--

/*!40000 ALTER TABLE `monitor_ping_region` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_ping_region` ENABLE KEYS */;


--
-- Definition of table `monitor_ping_region_group`
--
...
CREATE TABLE `monitor_ping_region_group` (
  ...
  `SUBNET_ID` int(11) default NULL,
  PRIMARY KEY  (`ID`),
  KEY `FK_PING_GROUP_SUBNET` (`SUBNET_ID`),
  CONSTRAINT `FK_PING_GROUP_SUBNET` FOREIGN KEY (`SUBNET_ID`) REFERENCES `monitor_subnet` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `monitor_ping_region_group`
--

/*!40000 ALTER TABLE `monitor_ping_region_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_ping_region_group` ENABLE KEYS */;


--
-- Definition of table `monitor_ping_response_record`
--
...
--
-- Dumping data for table `monitor_ping_response_record`
--

/*!40000 ALTER TABLE `monitor_ping_response_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_ping_response_record` ENABLE KEYS */;


--
-- Definition of table `monitor_ping_result`
--
...
CREATE TABLE `monitor_ping_result` (
  ...
  CONSTRAINT `FK_RESULT_DEST` FOREIGN KEY (`PING_DEST_ID`) REFERENCES `monitor_ping_dest` (`ID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `monitor_ping_result`
--

/*!40000 ALTER TABLE `monitor_ping_result` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_ping_result` ENABLE KEYS */;


--
-- Definition of table `monitor_ping_result_day`
--
...
--
-- Dumping data for table `monitor_ping_result_day`
--

/*!40000 ALTER TABLE `monitor_ping_result_day` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_ping_result_day` ENABLE KEYS */;


--
-- Definition of table `monitor_ping_time_point`
--
...
--
-- Dumping data for table `monitor_ping_time_point`
--

/*!40000 ALTER TABLE `monitor_ping_time_point` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_ping_time_point` ENABLE KEYS */;


--
-- Definition of table `monitor_realtime_cpu`
--
...
--
-- Dumping data for table `monitor_realtime_cpu`
--

/*!40000 ALTER TABLE `monitor_realtime_cpu` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_realtime_cpu` ENABLE KEYS */;


--
-- Definition of table `monitor_realtime_delay`
--
...
--
-- Dumping data for table `monitor_realtime_delay`
--

/*!40000 ALTER TABLE `monitor_realtime_delay` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_realtime_delay` ENABLE KEYS */;


--
-- Definition of table `monitor_realtime_fault`
--
...
--
-- Dumping data for table `monitor_realtime_fault`
--

/*!40000 ALTER TABLE `monitor_realtime_fault` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_realtime_fault` ENABLE KEYS */;


--
-- Definition of table `monitor_realtime_portflow`
--
...
--
-- Dumping data for table `monitor_realtime_portflow`
--

/*!40000 ALTER TABLE `monitor_realtime_portflow` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_realtime_portflow` ENABLE KEYS */;


--
-- Definition of table `monitor_realtime_use`
--
...
--
-- Dumping data for table `monitor_realtime_use`
--

/*!40000 ALTER TABLE `monitor_realtime_use` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_realtime_use` ENABLE KEYS */;


--
-- Definition of table `monitor_regular_data`
--
...
--
-- Dumping data for table `monitor_regular_data`
--

/*!40000 ALTER TABLE `monitor_regular_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_regular_data` ENABLE KEYS */;


--
-- Definition of table `monitor_regular_data_day`
--
...
--
-- Dumping data for table `monitor_regular_data_day`
--

/*!40000 ALTER TABLE `monitor_regular_data_day` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_regular_data_day` ENABLE KEYS */;


--
-- Definition of table `monitor_regular_data_hour`
--
...
--
-- Dumping data for table `monitor_regular_data_hour`
--

/*!40000 ALTER TABLE `monitor_regular_data_hour` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_regular_data_hour` ENABLE KEYS */;


--
-- Definition of table `monitor_report_task`
--
...
--
-- Dumping data for table `monitor_report_task`
--

/*!40000 ALTER TABLE `monitor_report_task` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_report_task` ENABLE KEYS */;


--
-- Definition of table `monitor_segment`
--
...
--
-- Dumping data for table `monitor_segment`
--

/*!40000 ALTER TABLE `monitor_segment` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_segment` ENABLE KEYS */;


--
-- Definition of table `monitor_server_process`
--
...
--
-- Dumping data for table `monitor_server_process`
--

/*!40000 ALTER TABLE `monitor_server_process` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_server_process` ENABLE KEYS */;


--
-- Definition of table `monitor_snapshot`
--
...
--
-- Dumping data for table `monitor_snapshot`
--

/*!40000 ALTER TABLE `monitor_snapshot` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_snapshot` ENABLE KEYS */;


--
-- Definition of table `monitor_subnet`
--
...
CREATE TABLE `monitor_subnet` (
  ...
  `LINK_DIRECTION` int(11) default NULL COMMENT '链路方向',
  `LAYOUT` int(11) default '0' COMMENT '打开时的布局',
  PRIMARY KEY  (`ID`),
...
--
-- Dumping data for table `monitor_subnet`
--

/*!40000 ALTER TABLE `monitor_subnet` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_subnet` ENABLE KEYS */;


--
-- Definition of table `monitor_subnet_device`
--
...
--
-- Dumping data for table `monitor_subnet_device`
--

/*!40000 ALTER TABLE `monitor_subnet_device` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_subnet_device` ENABLE KEYS */;


--
-- Definition of table `monitor_subnet_type`
--
...
--
-- Dumping data for table `monitor_subnet_type`
--

/*!40000 ALTER TABLE `monitor_subnet_type` DISABLE KEYS */;
INSERT INTO `monitor_subnet_type` (`CODE`,`NAME`,`ISUSE`) VALUES 
 (1,'交换',1),
 (2,'路由',1),
 (3,'服务器',1),
 (4,'业务',1),
 (9,'区域',1);
/*!40000 ALTER TABLE `monitor_subnet_type` ENABLE KEYS */;


--
-- Definition of table `monitor_switch_model`
--
...
--
-- Dumping data for table `monitor_switch_model`
--

/*!40000 ALTER TABLE `monitor_switch_model` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_switch_model` ENABLE KEYS */;


--
-- Definition of table `monitor_system_param`
--
...
--
-- Dumping data for table `monitor_system_param`
--

/*!40000 ALTER TABLE `monitor_system_param` DISABLE KEYS */;
INSERT INTO `monitor_system_param` (`CODE`,`PARAM`,`VALUE`,`HIGH_VALUE`,`NOTE`,`TYPE`,`ISUSE`) VALUES 
 ('AdminPwd','系统管理员密码','',NULL,NULL,'other',1),
 ('AlertDataKeep','报警保存记录数','30000',NULL,NULL,'alert',1),
 ('AntiAliased','消除锯齿','0',NULL,NULL,'topo',1),
 ('ArpLimen','Arp警示阈值（个）','5','10','','alert',1),
 ('ArpNbt','Netbios扫描','0',NULL,'默认为0，不进行Netbios扫描','scan',1),
 ('BackColor','背景颜色','白',NULL,NULL,'topo',1),
 ('BackPicPath','拓扑图默认背景图片路径','images/monitor/defaultBackPic.jpg',NULL,NULL,'topo',1),
 ('BackupType','备份、恢复配置包含历史数据','0',NULL,'默认不备份历史数据，暂时未使用','history',0),
 ('BandHighLimen','带宽严重警示阈值（%）','30',NULL,NULL,'topo',1),
 ('BandLimen','带宽警示阈值（%）','1','10','','topo',1),
 ('BroadcastLimen','广播包警示阈值（个/ 秒）','50','100','','topo',1),
 ('ChangeAlert','计算机信息改变后报警','1',NULL,'计算机类报警','scan',1),
 ('ChangeRefresh','报警后进行归档','1',NULL,'（计算机类报警）报警后自动归档','scan',1),
 ('CheckGap','故障检查间隔','5','0 0/5 * * * ?','单位为秒','time',1),
 ('ComputerNameChangedAlert','计算机名改变','1',NULL,NULL,'scan',1),
 ('CpuHighLimen','CPU严重警示阈值（%）','60',NULL,NULL,'topo',1),
 ('CpuLimen','CPU警示阈值（%）','1','60','','topo',1),
 ('DeleteGap','计算机表过期删除时间','三个月',NULL,'','time',1),
 ('DeviceBgPath','设备拓扑背景图','',NULL,NULL,'topo',1),
 ('DiskRate','磁盘使用率（%）','90','95','','server',1),
 ('DomainChangedAlert','域或组改变','1',NULL,NULL,'scan',1),
 ('EmailSwitch','邮件报警','1',NULL,'邮件报警开关，默认0，关','alert',1),
 ('ErrorGap','异常后的监测时间间隔','1','0 0/1 * * * ?','单位为秒','time',1),
 ('ExportFile','输出图像/数据到文件','1',NULL,'默认为真','topo',1),
 ('FluxScanGapTime','流量及CPU采集间隔','5','0 0/5 * * * ?',NULL,'scan',1),
 ('FluxSwitch','启用流量、CPU采集(5分钟)','1',NULL,'默认启用流量采集','history',1),
 ('FluxType','流量采集类型','1',NULL,NULL,'history',1),
 ('HostBgPath','服务器拓扑背景图','',NULL,NULL,'topo',1),
 ('HourDataKeep','小时历史数据保存时长','90',NULL,NULL,'history',1),
 ('IgnoreError','忽略MAC转发异常','1',NULL,'默认为1，忽略MAC转发异常','scan',1),
 ('IPChangedAlert','IP地址改变','1',NULL,NULL,'scan',1),
 ('L23Scan','扫描MAC转发表&ARP表','0',NULL,NULL,'scan',1),
 ('LimitToAddLevel','报警升级门限','100',NULL,NULL,NULL,NULL),
 ('LinkChangedAlert','交换机接口改变','1',NULL,NULL,'scan',1),
 ('MailSender','发送Email帐号','',NULL,NULL,'alert',1),
 ('MailSenderPwd','发送Email帐号密码','',NULL,NULL,'alert',1),
 ('MaxBroadcast','是否在拓扑图中标识出向心广播包最多的节点','1',NULL,NULL,'topo',1),
 ('MaxFlow','是否在拓扑图中标识出向心广播包最多的节点','1',NULL,NULL,'topo',1),
 ('MemRate','内存使用率（%）','90','95','','server',1),
 ('MinuteDataKeep','分钟历史数据保存时长','7',NULL,NULL,'history',1),
 ('MobileSwitch','短信报警','1',NULL,NULL,'alert',1),
 ('NewHost','新计算机','1',NULL,NULL,'scan',1),
 ('PingAutoExcuteMode',' ping的自动执行模式','0',NULL,NULL,NULL,1),
 ('PingDayInWeek','ping时间（星期几）','02,04,01',NULL,NULL,NULL,NULL),
 ('PingDetailLife','ping细节表保存时间','2',NULL,NULL,NULL,1),
 ('PingEndTimeOfDay','Ping结束时间','23',NULL,NULL,'alert',1),
 ('PingExcuteMode','ping执行模式','1',NULL,NULL,NULL,1),
 ('PingIsDefineHours','在下列时间段才监测','1',NULL,NULL,NULL,NULL),
 ('PingLoopGap','ping扫描间隔时间','5','0 0/20 21-23 ? * 02,04,01',NULL,NULL,1),
 ('PingNum','ping次数','4',NULL,NULL,NULL,1),
 ('PingReportLife','ping统计表保存时间','180',NULL,NULL,NULL,1),
 ('PingScan','Ping预扫描','0',NULL,'','scan',1),
 ('PingSize','ping包长度','32',NULL,NULL,NULL,1),
 ('PingStartTimeOfDay','Ping开始时间','4',NULL,NULL,'alert',1),
 ('PingTimeout','ping超时时间','4000',NULL,NULL,NULL,1),
 ('PollGap','数据刷新间隔','5','0 0/5 * * * ?','拓扑图轮询间隔','topo',1),
 ('ProcNum','进程数','50','80','','server',1),
 ('ScanGapTime','扫描间隔(分钟)','30','0 0/30 * * * ?',NULL,'scan',1),
 ('ScanHour0','定时扫描时间1','10',NULL,NULL,'scan',1),
 ('ScanHour1','定时扫描时间2','16',NULL,NULL,'scan',1),
 ('ScanHour2','定时扫描时间3','20',NULL,NULL,'scan',1),
 ('ScrollTime','幻灯显示间隔（秒）','10',NULL,NULL,'time',1),
 ('SmsSn','短信猫序列号','',NULL,NULL,'alert',1),
 ('SmtpServer','发送SMTP服务器','',NULL,NULL,'alert',1),
 ('SnmpRetry','SNMP重试次数','1',NULL,NULL,'other',1),
 ('SnmpTimeOut','SNMP 网络超时时间','5',NULL,NULL,'other',1),
 ('SoundSwitch','声音报警','1',NULL,NULL,'alert',1),
 ('SyncHour','自动同步时间','不定时同步',NULL,NULL,'other',1),
 ('SyncServer','数据同步网管站IP','',NULL,NULL,'other',1),
 ('TcpConn','TCP连接数','100','150','','server',1),
 ('TempHighLimen','温度严重警示阈值（度）','40',NULL,NULL,'topo',1),
 ('TempLimen','温度警示阈值（度）','25','40','','topo',1),
 ('ToolIp1','带IP参数','1',NULL,NULL,'other',1),
 ('ToolIp2','带IP参数','0',NULL,NULL,'other',1),
 ('ToolName1','工具一名称','',NULL,NULL,'other',1),
 ('ToolName2','工具二名称','',NULL,NULL,'other',1),
 ('ToolPath1','工具一路径','',NULL,NULL,'other',1),
 ('ToolPath2','工具二路径','',NULL,NULL,'other',1),
 ('TopN','TopN','10',NULL,NULL,'other',1),
 ('UnicastLimen','单播包警示阈值（个/ 秒）','2000','2000','','topo',1),
 ('UserBgPath','用户拓扑背景图','',NULL,NULL,'topo',1),
 ('UserChangedAlert','登录名改变','1',NULL,NULL,'scan',1),
 ('UserPwd','普通用户密码','',NULL,NULL,'other',1),
 ('VmemRate','虚存使用率（%）','90','95','','server',1);
/*!40000 ALTER TABLE `monitor_system_param` ENABLE KEYS */;


--
-- Definition of table `monitor_tcp_port`
--
...
--
-- Dumping data for table `monitor_tcp_port`
--

/*!40000 ALTER TABLE `monitor_tcp_port` DISABLE KEYS */;
INSERT INTO `monitor_tcp_port` (`PORT_NUMBER`,`PORT_NAME`,`PORT_TYPE`) VALUES 
 ('110','POP3','TCP'),
 ('1433','MS-SQL','TCP'),
 ('1521','ORACLE','TCP'),
 ('21','FTP','TCP'),
 ...
 ('80','HTTP','TCP'),
 ('8080','WWWCache','TCP');
/*!40000 ALTER TABLE `monitor_tcp_port` ENABLE KEYS */;


--
-- Definition of table `monitor_topology_edge`
--
...
--
-- Dumping data for table `monitor_topology_edge`
--

/*!40000 ALTER TABLE `monitor_topology_edge` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_topology_edge` ENABLE KEYS */;


--
-- Definition of table `monitor_topology_node`
--
...
--
-- Dumping data for table `monitor_topology_node`
--

/*!40000 ALTER TABLE `monitor_topology_node` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_topology_node` ENABLE KEYS */;


--
-- Definition of table `monitor_url_response`
--
...
--
-- Dumping data for table `monitor_url_response`
--

/*!40000 ALTER TABLE `monitor_url_response` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_url_response` ENABLE KEYS */;


--
-- Definition of table `monitor_url_service`
--
...
--
-- Dumping data for table `monitor_url_service`
--

/*!40000 ALTER TABLE `monitor_url_service` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_url_service` ENABLE KEYS */;


--
-- Definition of table `monitor_url_type`
--
...
--
-- Dumping data for table `monitor_url_type`
--

/*!40000 ALTER TABLE `monitor_url_type` DISABLE KEYS */;
INSERT INTO `monitor_url_type` (`ID`,`NAME`,`DESCRIPTION`,`CONFIGER`,`MONITOR`,`EXTEND_OID`,`SORT`,`AUTO_DISCOVER`,`PORTS`,`TIMEOUT`,`MONITOR_INTERVAL`,`ERRATUM_INTERVAL`) VALUES 
 ('HTTP','HTTP服务','使用HTTP协议监测Web服务器，可以监测Web服务器运行状态是否正常。','netmon.monitor.http.HTTPParamConfiger','netmon.monitor.http.HTTPMonitor','1',3,1,'80',5000,600,300),
 ('HTTPS','HTTPS服务','使用HTTPS协议监测Web服务器，可以监测Web服务器运行状态是否正常。','netmon.monitor.https.HTTPSParamConfiger','netmon.monitor.https.HTTPSMonitor','2',3,1,'443',5000,600,300);
/*!40000 ALTER TABLE `monitor_url_type` ENABLE KEYS */;


--
-- Definition of table `monitor_user`
--
...
--
-- Dumping data for table `monitor_user`
--
...
--
-- Definition of table `monitor_v3_auth`
--
...
--
-- Dumping data for table `monitor_v3_auth`
--

/*!40000 ALTER TABLE `monitor_v3_auth` DISABLE KEYS */;
INSERT INTO `monitor_v3_auth` (`ID`,`PROTOCOL`,`NAME`,`NOTE`) VALUES 
 (1,21,'MD5','MD5_AUTH'),
 (2,22,'SHA','SHA_AUTH');
/*!40000 ALTER TABLE `monitor_v3_auth` ENABLE KEYS */;


--
-- Definition of table `monitor_v3_params`
--
...
--
-- Dumping data for table `monitor_v3_params`
--

/*!40000 ALTER TABLE `monitor_v3_params` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_v3_params` ENABLE KEYS */;


--
-- Definition of table `monitor_v3_priv`
--
...
--
-- Dumping data for table `monitor_v3_priv`
--

/*!40000 ALTER TABLE `monitor_v3_priv` DISABLE KEYS */;
INSERT INTO `monitor_v3_priv` (`ID`,`PROTOCOL`,`NAME`,`NOTE`) VALUES 
 (1,46,'CBC-3DES','CBC-3DES'),
 (2,50,'CBC-DES','CBC-DES'),
 (3,49,'CFB-AES-128','CFB-AES-128'),
 (4,48,'CFB-AES-192','CFB-AES-192'),
 (5,47,'CFB-AES-256','CFB-AES-256');
/*!40000 ALTER TABLE `monitor_v3_priv` ENABLE KEYS */;


--
-- Definition of table `monitor_v3_security_level`
--
...
--
-- Dumping data for table `monitor_v3_security_level`
--

/*!40000 ALTER TABLE `monitor_v3_security_level` DISABLE KEYS */;
INSERT INTO `monitor_v3_security_level` (`ID`,`LEVEL`,`NAME`,`NOTE`) VALUES 
 (1,0,'NoAuth,NoPriv','NO_AUTH_NO_PRIV'),
 (2,1,'Auth,NoPriv','AUTH_NO_PRIV'),
 (3,2,'Auth,Priv','AUTH_PRIV');
/*!40000 ALTER TABLE `monitor_v3_security_level` ENABLE KEYS */;


--
-- Definition of table `monitor_vendor`
--
...
--
-- Dumping data for table `monitor_vendor`
--

/*!40000 ALTER TABLE `monitor_vendor` DISABLE KEYS */;
INSERT INTO `monitor_vendor` (`VENDOR`,`CPU_OID`,`TEMPERATURE`,`NOTE`) VALUES 
 ('11','.1.3.6.1.4.1.11.2.14.11.5.1.9.6.1.0',NULL,'Hp'),
 ('1916','.1.3.6.1.4.1.1916.1.1.1.28.0','.1.3.6.1.4.1.1916.1.1.1.8.0','Extreme'),
 ('1991','.1.3.6.1.4.1.1991.1.1.2.1.51.0',NULL,'Foundry'),
 ('2011','.1.3.6.1.4.1.2011.2.23.1.18.1.3.0',NULL,'Huawei'),
 ('2272','.1.3.6.1.4.1.2272.1.1.20.0',NULL,'BAY'),
 ('25506','.1.3.6.1.4.1.2011.10.2.6.1.1.1.1.6.7',NULL,'H3C'),
 ('2636','.1.3.6.1.4.1.2636.3.1.13.1.8.9.1.0.0',NULL,'Juniper'),
 ('311','.1.3.6.1.2.1.25.3.3.1.2',NULL,'MS'),
 ('3854','.1.3.6.1.4.1.3854.1.2.2.1.16.1.3.0',NULL,'AKCP'),
 ('3902','.1.3.6.1.4.1.3902.3.3.1.1.5',NULL,'ZX'),
 ('4881','.1.3.6.1.4.1.4881.1.1.10.2.36.1.1.1.0',NULL,'Ruijie'),
 ('6339','.1.3.6.1.4.1.6339.100.1.11.0',NULL,'DCS'),
 ('6486','.1.3.6.1.4.1.6486.800.1.2.1.16.1.1.1.13.0',NULL,'Alcatel'),
 ('8212','.1.3.6.1.4.1.8212.1.1.4.1.1.4.1',NULL,'Harbour'),
 ('9','.1.3.6.1.4.1.9.2.1.56.0','.1.3.6.1.4.1.9.9.13.1.3.1.3.1','Cisco');
/*!40000 ALTER TABLE `monitor_vendor` ENABLE KEYS */;


--
-- Definition of table `monitor_vendor_mac`
--
...
--
-- Dumping data for table `monitor_vendor_mac`
--

/*!40000 ALTER TABLE `monitor_vendor_mac` DISABLE KEYS */;
INSERT INTO `monitor_vendor_mac` (`ID`,`NAME`,`MAC`,`ISUSE`) VALUES 
 (1,'思科/3COM','m',1),
 (2,'华3/神码','p',1),
 (3,'锐捷.1924F+','RG.1924F+',1),
 (4,'锐捷.1926F+','RG.1926F+',1),
 (5,'锐捷.1926G+','RG.1926G+',1),
 (6,'锐捷.2024E','RG.2024E',1),
 (7,'锐捷.2024M','RG.2024M',1),
 (8,'锐捷.2126G/2150G','RG.2150G',1),
 (9,'锐捷.MAC绑定','RG.BD',1),
 (10,'港湾.5610/2948','GW.1',1),
 (11,'港湾.5010/2824/3550','GW.2',1),
 (12,'港湾.U2/U4','GW.3',1),
 (13,'华为','HW.6506',1),
 (14,'中兴','ZX.2826',1),
 (15,'思科无线AP','CISCO.AP',1);
/*!40000 ALTER TABLE `monitor_vendor_mac` ENABLE KEYS */;


--
-- Definition of table `monitor_vlan`
--
...
--
-- Dumping data for table `monitor_vlan`
--

/*!40000 ALTER TABLE `monitor_vlan` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_vlan` ENABLE KEYS */;


--
-- Definition of table `monitor_zone_vlan`
--
...
--
-- Dumping data for table `monitor_zone_vlan`
--

/*!40000 ALTER TABLE `monitor_zone_vlan` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitor_zone_vlan` ENABLE KEYS */;


--
-- Definition of table `personal_notice`
--
...
--
-- Dumping data for table `personal_notice`
--

/*!40000 ALTER TABLE `personal_notice` DISABLE KEYS */;
/*!40000 ALTER TABLE `personal_notice` ENABLE KEYS */;
...
--
-- Definition of table `problem_type`
--
...
--
-- Definition of table `project_manage`
--
...
--
-- Dumping data for table `project_manage`
--

/*!40000 ALTER TABLE `project_manage` DISABLE KEYS */;
/*!40000 ALTER TABLE `project_manage` ENABLE KEYS */;


--
-- Definition of table `report_mana`
--
...
--
-- Dumping data for table `report_mana`
--

/*!40000 ALTER TABLE `report_mana` DISABLE KEYS */;
/*!40000 ALTER TABLE `report_mana` ENABLE KEYS */;


--
-- Definition of table `role_group`
--
...
--
-- Definition of table `role_table`
--
...
INSERT INTO `role_table` (`id`,`enname`,`chname`,`description`,`prop`) VALUES 
 (1,'assets_base','资产列表','所有资产信息',NULL);
/*!40000 ALTER TABLE `role_table` ENABLE KEYS */;


--
-- Definition of table `role_table_privilege`
--
...
--
-- Dumping data for table `role_table_privilege`
--

/*!40000 ALTER TABLE `role_table_privilege` DISABLE KEYS */;
INSERT INTO `role_table_privilege` (`id`,`roleID`,`tableID`,`privilege`,`prop`) VALUES 
 (1,3,1,0,NULL),
 (2,4,1,2,NULL);
/*!40000 ALTER TABLE `role_table_privilege` ENABLE KEYS */;


--
-- Definition of table `roleteam`
--
...
--
-- Dumping data for table `roleteam`
--

/*!40000 ALTER TABLE `roleteam` DISABLE KEYS */;
INSERT INTO `roleteam` (`id`,`locationID`,`name`,`type`,`description`,`orderNo`,`teamleader`,`useFor`,`roletype`,`roletypename`,`rolegroup`) VALUES 
 (1,NULL,'管理员','0',NULL,NULL,NULL,3,4,'管理员',0),
 (2,NULL,'用户(系统预置)','0',NULL,NULL,NULL,1,3,'用户',0),
 (3,NULL,'工程师(系统预置)','0',NULL,NULL,NULL,1,1,'工程师',0),
 (4,NULL,'IT经理(系统预置)','0',NULL,NULL,NULL,1,2,'经理',0);
/*!40000 ALTER TABLE `roleteam` ENABLE KEYS */;


--
-- Definition of table `schedualed_task_detail`
--
...
--
-- Dumping data for table `schedualed_task_detail`
--

/*!40000 ALTER TABLE `schedualed_task_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `schedualed_task_detail` ENABLE KEYS */;


--
-- Definition of table `schedualed_task_diary`
--
...
--
-- Dumping data for table `schedualed_task_diary`
--

/*!40000 ALTER TABLE `schedualed_task_diary` DISABLE KEYS */;
/*!40000 ALTER TABLE `schedualed_task_diary` ENABLE KEYS */;


--
-- Definition of table `schedualed_task_user`
--
...
--
-- Dumping data for table `schedualed_task_user`
--

/*!40000 ALTER TABLE `schedualed_task_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `schedualed_task_user` ENABLE KEYS */;


--
-- Definition of table `schedualed_tasks`
--
...
--
-- Dumping data for table `schedualed_tasks`
--

/*!40000 ALTER TABLE `schedualed_tasks` DISABLE KEYS */;
/*!40000 ALTER TABLE `schedualed_tasks` ENABLE KEYS */;
...
--
-- Definition of table `service_category`
--
...
INSERT INTO `service_category` (`id`,`formguide_id`,`item`,`type`,`code`,`item_zh`,`explainer`,`ico_url`,`open_object`,`self_service`,`description`,`isFormguide`,`defEss`,`defEme`,`isDef`,`pid`,`workflow`,`approver`,`charset`,`sla`) VALUES 
 (1,NULL,'',1,'|1$','用户问题','用户问题','',NULL,'0',0,NULL,2,2,NULL,0,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `service_category` ENABLE KEYS */;


--
-- Definition of table `service_level`
--
...
--
-- Definition of table `service_request_assets`
--
...
--
-- Dumping data for table `service_request_assets`
--

/*!40000 ALTER TABLE `service_request_assets` DISABLE KEYS */;
/*!40000 ALTER TABLE `service_request_assets` ENABLE KEYS */;


--
-- Definition of table `service_tran`
--
...
--
-- Dumping data for table `service_tran`
--

/*!40000 ALTER TABLE `service_tran` DISABLE KEYS */;
/*!40000 ALTER TABLE `service_tran` ENABLE KEYS */;


--
-- Definition of table `severity_typ`
--
...
--
-- Dumping data for table `severity_typ`
--

/*!40000 ALTER TABLE `severity_typ` DISABLE KEYS */;
INSERT INTO `severity_typ` (`id`,`severityType`,`severityValue`,`category`,`type`) VALUES 
 (1,'高',3,1,NULL),
 (2,'高',3,3,NULL),
 (3,'中',2,2,NULL),
 (4,'低',1,2,NULL),
 ...
 (12,'极高',4,3,NULL),
 (15,'极高',4,1,NULL);
/*!40000 ALTER TABLE `severity_typ` ENABLE KEYS */;
...
INSERT INTO `system_config` (`id`,`enfield`,`chfield`,`value`,`property1`,`value1`,`property2`,`value2`,`property3`,`value3`,`property4`,`value4`,`createuser`,`createtime`,`lastmodifyuser`,`lastmodifytime`) VALUES 
 ('1','isLdap','是否开启LDAP','false',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
--
-- Definition of table `system_notice`
--
...
/*!40000 ALTER TABLE `task_cat` DISABLE KEYS */;
/*!40000 ALTER TABLE `task_cat` ENABLE KEYS */;


--
-- Definition of table `task_dep`
--
...
--
-- Dumping data for table `task_dep`
--

/*!40000 ALTER TABLE `task_dep` DISABLE KEYS */;
/*!40000 ALTER TABLE `task_dep` ENABLE KEYS */;


--
-- Definition of table `task_team`
--
...
--
-- Definition of table `taskallocation`
--
...
--
-- Definition of table `user_roleteam`
--
...
--
-- Dumping data for table `user_roleteam`
--

/*!40000 ALTER TABLE `user_roleteam` DISABLE KEYS */;
INSERT INTO `user_roleteam` (`roleID`,`userID`) VALUES 
 (1,1);
/*!40000 ALTER TABLE `user_roleteam` ENABLE KEYS */;
...
INSERT INTO `users` (`id`,`departmentID`,`locationID`,`managerID`,`username`,`password`,`truename`,`usertype`,`phone`,`cellphone`,`address`,`email`,`last_AccessTime`,`last_AccessIP`,`status`,`online`,`description`,`sex`,`birthday`,`add1`,`add2`,`add3`,`LDAP_ID`,`USER_DN`,`num_worklog`) VALUES 
 (1,1,1,1,'admin','admin','admin','system','010-82550123','13265489877','康邦公司','admin@combanc.com.cn',NULL,NULL,1,NULL,NULL,NULL,NULL,32,NULL,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `users` ENABLE KEYS */;


--
-- Definition of table `util_keytable`
--
...
--
-- Dumping data for table `util_keytable`
--

/*!40000 ALTER TABLE `util_keytable` DISABLE KEYS */;
/*!40000 ALTER TABLE `util_keytable` ENABLE KEYS */;


--
-- Definition of table `work_log`
--
...
alter table assets_base change column maintainance_cost ishis int(11) default '0';
INSERT INTO `config_record` (`id`,`record_name`,`record_description`,`assets_type_id`,`is_assetsinfo`) VALUES 
 (1,'政府机关使用','1',NULL,0),
 (2,'医疗机构','2',NULL,1),
 (3,'中小学','3',NULL,0),
 (4,'大学','4',NULL,0);
 
insert into menu(id,roletype,parentid,name,type,module,url,visiable,privfield,addtime,adduser,orderflag,icon)
values(115,'1:2',15,'服务请求处理统计',2,2,'srstatistic/getEngineerWorkStatics.action','Y','search:搜索','2010-02-25 10:00:00','admin',6,'images/icons/icon032a12.gif');
INSERT INTO `privilege`(`OWNERTYPE`,`OWENR`,`PRIVTYPE`,`MID`,`CODE`,`Value`) VALUES ('R', 4, 'menu', '115', 'browse', '1');
INSERT INTO `privilege`(`OWNERTYPE`,`OWENR`,`PRIVTYPE`,`MID`,`CODE`,`Value`) VALUES ('R', 4, 'menu', '115', 'search', '1');
