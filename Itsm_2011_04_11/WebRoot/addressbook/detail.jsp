...
<html>
	...
	<body background="${pageContext.request.contextPath }/img/main.jpg" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="overflow:hidden; background-repeat: repeat-x; padding: 4px; border: 1px inset" >
		...
		<div>
			<table width="99%"  border="0" align="center"
				...
				<tr>
					<td valign="top" id="mainright" style="border:#b5d6e6 1px solid;"><table width="100%" height="95%" cellspacing="0" bgcolor="#b5d6e6">
																<s:iterator value="#request.addressBook" id="u">
																	<tr>
																	...
																	<tr>
																		...
																		<td height="10%" width="20%" bgcolor="#FFFFFF">
																			<s:property value="#u.department.name" />
																		</td>
																	</tr>
																	...
																	<tr>
																		...
																		<td height="10%" valign="top" width="20%"
																			bgcolor="#FFFFFF">
																...
																<tr>
																	<td height="30" colspan="2" align="right" bgcolor="#FFFFFF"><table width="100" border="0" align="center" cellpadding="0"
																			cellspacing="0" background="images/addnew002.gif">
																	  <tr style="cursor: hand;">
																	    <td><img src="images/addnew001.gif"></td>
																	    <td
																					onClick="javascript:window.location.href='<%=request.getContextPath()%>/AddressBookManage/myContact.action'"> 后&nbsp;&nbsp;退 </td>
