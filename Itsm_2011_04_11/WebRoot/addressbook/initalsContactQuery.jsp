...
<html>
	...
	function deleteAddressBook()
	{
		...
		{
			window.location.href = "delete.action?addressBookIds=" + result
		}
	}
							...
							<s:form action="query" method="post" theme="simple"
								...
								<tr>
									...
									<td width="22%" bgcolor="#ffffff" style="padding-right: 10px">
										<input type="text" name="username" style="width: 120px; height:18px;" />
									</td>
...
<td width="26%" bgcolor="#ffffff" style="padding-right: 10px">
				<select id="department" name="departmentId" style="width: 50%; height:18px;"></select>
									...
									<tags:button code="search" menu="31"><td width="21%" align="center" bgcolor="#deebf1" style="padding-right: 10px"><input type="submit" value="查询" class=mmBtn name="submit" style="height: 20px" /></td></tags:button>
								</tr>
							</s:form>
					  </table>
...
class="alllisttitle"> MSN </th>
										      
									        </tr>
										    <s:iterator 

value="pageBean.list" id="u">
										      <tr 

bgcolor="#FFFFFF" onMouseOver="this.bgColor='#e3f0f7'"
...
<s:property value="#u.username" />
										        ...
										        <td align="center" class="zczb_qua"><s:property value="#u.msn" /></td>
									          </tr>
									        </s:iterator>
									      </table></td>
					    </tr>
							...
							onclick="javascript:window.location.href='../AddressBookManage/myContact.action'"
							class="mmBtn" /></td>
							      </tr>
		  ...
		  <s:form name="form" method="post"
				action="/AddressBookManage/firstQueryContact.action" theme="simple">
