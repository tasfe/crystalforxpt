...
<table cellspacing=0 cellpadding=0 border=0 width="100%">
  <tr>
   ...
   <td width="98%" background="../../images/main20100521_582.gif" style="color:#FFFFFF; font-weight:bold;">查看详细</td>
  </tr>
</table>
<table width="100%" height="95%" border="0" cellpadding="5" cellspacing="1" bgcolor="#6d9db4">
  <tr>
