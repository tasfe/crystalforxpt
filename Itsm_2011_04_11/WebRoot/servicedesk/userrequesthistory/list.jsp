...
<table width="99%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#6d9db4">
  <tr>
    <td valign="top" bgcolor="#FFFFFF"><table cellspacing=0 cellpadding=0 border=0 width="100%">
      <tr>
        <td nowrap><img src="../img/Help2.gif" width="22" height="23" align="absmiddle">&nbsp;</td>
              ...
              <td height="2" colspan="2"><div style="position:absolute; width:100%; height:15px; z-index:9; cursor: default; overflow-x: hidden; border: 1px outset">
                  <table width="100%" border="0" cellpadding="1" cellspacing="0" bgcolor="white">
                    <tr>
                      ...
                      <td nowrap onMouseOver="this.bgColor='#648AC4';this.style.color='white'" onMouseOut="this.bgColor='white';this.style.color='#333333'" bgcolor="white" onClick="window.location='tracelist.action?type=0&state=4'">&nbsp;拒绝请求</td>
                    </tr>
                   
                                    <tr>
                      <td bgcolor="white" width="1%"><img width=18 height=18 src="../img/ServiceInput.gif" align=absmiddle></td>
                      <td nowrap onMouseOver="this.bgColor='#648AC4';this.style.color='white'" onMouseOut="this.bgColor='white';this.style.color='#333333'" bgcolor="white" onClick="window.location='tracelist.action?type=0&state=5'">&nbsp;等待反馈</td>
                    </tr>
                                     <tr>
                      <td bgcolor="white" width="1%"><img width=18 height=18 src="../img/ServiceInput.gif" align=absmiddle></td>
                      <td nowrap onMouseOver="this.bgColor='#648AC4';this.style.color='white'" onMouseOut="this.bgColor='white';this.style.color='#333333'" bgcolor="white" onClick="window.location='tracelist.action?type=0&state=6'">&nbsp;已关闭</td>
                    </tr>
     ...
     <s:iterator value="pageBean.list" var="serviceRequests">
        <tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#e3f0f7'" onMouseOut="this.bgColor='#FFFFFF'">
          <td height="20" align="center"><s:property value="requestNo"/></td>
          ...
          <td align="center"><s:date name="promiseTime" format="yyyy/MM/dd HH:mm:ss" /></td>
          <td align="center"><s:property value="userByRequestUser.username"/></td>
          <s:if test="state==0">
          ...
          <td align="center">已拒绝</td> 
           ...
           <s:elseif test="state==5">
          <td nowrap onMouseOver="this.bgColor='#648AC4';this.style.color='white'" onMouseOut="this.bgColor='white';this.style.color='#333333'" bgcolor="white" align="center">
          <a style="color:#0033FF" onClick="window.open('asst/showstatisfaction.action?requestNo=${serviceRequests.requestNo}','','width=400,height=300,scrollbars=no,menubar=no,resizable=no,top=30,left=70,status=yes')"><i>提交反馈<i></a>
          ...
          <td align="center"><a href="showReqInfoHistory.action?requestNo=${serviceRequests.requestNo}" target="_self"><img src="../img/viewdetail.gif" align="absmiddle"></a></td>
       <%--   <td align="center"><a href="viewprogress.jsp"><img src="../img/processing.gif" align="absmiddle" alt="查看进度"></a></td> --%>
