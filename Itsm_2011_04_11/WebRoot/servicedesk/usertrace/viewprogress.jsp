	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"
		...
		<div
			...
			<table width="99%" height="80%" border="0" align="center"
				cellpadding="5" cellspacing="1" bgcolor="#6d9db4">
				<tr>
					<td valign="top" bgcolor="#FFFFFF">
						<table border="0" cellspacing="4" cellpadding="0">
							<tr>

								<s:iterator value="serviceTranList" var="serviceTran"
									status="stuts">
									...
									<td>
										<table border="0" cellspacing="1" cellpadding="0"
											...
											<tr class="td-right">
												<td nowrap width="99%" style="padding-left: 2px" height="19">
													<b><s:property value="type" /> </b>
												</td>
											</tr>
											<tr style="padding-left: 4px; padding-right: 5px">
												<td nowrap bgcolor="#F9F9F9">
				...
				<tr>
					<td align=center nowrap
						...
						<input name="button" type="button" class="mmBtn"
							onClick="window.location='showReqInfo.action?requestNo=${requestNo}'"
							value="详细信息">
					</td>
				</tr>
			</table>
