...
//assets/list.jsp  Layer1
if(window.parent.document.getElementById('assetsStateid')){
window.parent.document.getElementById('assetsStateid').value=ids;
}
if(window.parent.document.getElementById('assetsStatename')){
window.parent.document.getElementById('assetsStatename').value=names;
}
if(window.parent.document.getElementById('assetsState')){
window.parent.document.getElementById('assetsState').style.visibility='hidden';
}
}	
	...
	Ext.onReady(function(){
		...
		var typeTree = new Ext.tree.TreePanel({
			...
			loader: new Ext.tree.TreeLoader({
				dataUrl: "../utiltree/getassetsStateChildren.action",
