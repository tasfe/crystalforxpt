...
if(window.parent.document.getElementById('producerid')){
window.parent.document.getElementById('producerid').value=ids;
}
if(window.parent.document.getElementById('producername')){
window.parent.document.getElementById('producername').value=names;
}
if(window.parent.document.getElementById('producer')){
window.parent.document.getElementById('producer').style.visibility='hidden';
}
}	
	...
	Ext.onReady(function(){
		...
		var typeTree = new Ext.tree.TreePanel({
			...
			loader: new Ext.tree.TreeLoader({
				dataUrl: "../utiltree/getproducerChildren.action",
