...
if(window.parent.document.getElementById('itsmTypeid')){
window.parent.document.getElementById('itsmTypeid').value=ids;
}
if(window.parent.document.getElementById('itsmTypename')){
window.parent.document.getElementById('itsmTypename').value=names;
}
if(window.parent.document.getElementById('itsmType')){
window.parent.document.getElementById('itsmType').style.visibility='hidden';
}
}	
