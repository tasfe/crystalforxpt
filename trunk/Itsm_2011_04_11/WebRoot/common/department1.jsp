...
if(window.parent.document.getElementById('departmentid1')){
window.parent.document.getElementById('departmentid1').value=ids;
}
if(window.parent.document.getElementById('departmentname1')){
window.parent.document.getElementById('departmentname1').value=names;
}
if(window.parent.document.getElementById('department1')){
window.parent.document.getElementById('department1').style.visibility='hidden';
}
}	
