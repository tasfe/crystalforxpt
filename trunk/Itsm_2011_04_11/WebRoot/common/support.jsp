...
if(window.parent.document.getElementById('supportid')){
window.parent.document.getElementById('supportid').value=ids;
}
if(window.parent.document.getElementById('supportname')){
window.parent.document.getElementById('supportname').value=names;
}
if(window.parent.document.getElementById('support')){
window.parent.document.getElementById('support').style.visibility='hidden';
}
}	
	...
	Ext.onReady(function(){
		...
		var typeTree = new Ext.tree.TreePanel({
			...
			loader: new Ext.tree.TreeLoader({
				dataUrl: "../utiltree/getsupportChildren.action",
