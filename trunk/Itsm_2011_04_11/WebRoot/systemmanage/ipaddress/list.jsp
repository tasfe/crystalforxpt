...
<%
	...
	String requestURI = request.getContextPath() + "/ipaddress/list.action";
%>
<html>
	<head>
...
function open1(id)
{
   ...
   diag.Width = 800;
	...
	diag.URL = "show.action?ipAddressId="+id;
	diag.show();

}

function changepage(page){
document.form1.action="query.action?page="+page;
document.form1.method="post";
document.form1.submit();
}
     ...
     <tr>
      ...
      <td width="98%" background="../images/main20100521_582.gif" style="color:#FFFFFF; font-weight:bold;">IP地址申请</td>
	    ...
	    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#b5d6e6">   
         <tr bgcolor="#b5d6e6">
          ...
          <td bgcolor="#deebf1" align="center">
           <tags:button code="search" menu="99">
       ...
       <tr>
          ...
          <td bgcolor="#deebf1" align="center">
          <tags:button code="reset" menu="99">
	   ...
	   <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
	     <tr>
				<td align="right">
				 <tags:button code="export" menu="99">
				  <input type="button" class="mmBtn" value="导出IP申请" onClick="window.location='<%=request.getContextPath()%>/ipaddress/export.action'">				
				</tags:button>
				 <tags:button code="add" menu="99">
			...
			<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#b5d6e6">
			 <tr bgcolor="#FFFFFF">
			  ...
			  <td align="center" width="15%" background="../images/main20100521_58.gif" class="alllisttitle">申请IP地址用途</td>
			  ...
			  <td align="center" width="4%" background="../images/main20100521_58.gif"	class="alllisttitle">打印</td>
			 </tr>
			<s:iterator value="pageBean.list" var="ipAddress">
			 <tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#e3f0f7'" onMouseOut="this.bgColor='#FFFFFF'">
			  ...
			  <td align="center" class="zczb_qua">
			  			   <tags:button code="approve" menu="99">
				  <s:if test="#ipAddress.state==0"> <img src="../images/edt.gif">
				<a href="updateInput.action?ipAddressId=<s:property value="id"/>">待审批</a></s:if>
				 <s:if test="#ipAddress.state==1"> <img src="../images/edt1.gif" >
				已审批</s:if>
				</tags:button>
			  </td>
			  <td align="center" class="zczb_qua">
			  <tags:button code="delete" menu="99">
				  <s:if test="#ipAddress.state==0"> 	<img src="../images/del.gif">
				<a href="delete.action?ipAddressId=<s:property value="id"/>" onClick="javascript:return del()">删除</a></s:if>
			  ...
			  <td align="center" class="zczb_qua">
			  <tags:button code="detail" menu="99">
			  <img src="../images/icons/icon013a1.gif" height="15" width="15">
				<a href="show.action?ipAddressId=<s:property value="id"/>" target="_blank">打印</a>
				</tags:button>
			  </td>
			 </tr>
			</s:iterator>
