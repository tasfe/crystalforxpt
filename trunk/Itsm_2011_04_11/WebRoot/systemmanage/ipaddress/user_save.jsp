...
<s:form action="user_save" method="post" theme="simple" namespace="/ipaddress">
             ...
             <tr>
               <td valign="top" bgcolor="#EBF4FD"><table cellspacing=0 cellpadding=0 border=0 width="100%" class="zcxx_tab3">
                 ...
                 <tr>
                   ...
                   <td width="20%" height="30" align="left"><input type="text" id="ipAddress.applicationDate" name="ipAddress.applicationDate" style="width:85%;height=18;" class="Wdate"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" ></td>
                 </tr>
                 <tr>
             ...
             <tr>
               <td valign="top" bgcolor="#EBF4FD"><table cellspacing=0 cellpadding=0 border=0 width="100%" class="zcxx_tab3">
                 <tr>
                   ...
                   <td width="84%" height="30" align="left" ><input type="text" id="ipAddress.applyIpCause" name="ipAddress.applyIpCause" style="width:100%;height=80;"></td>
