...
<td valign="top" id="mainright">
	...
	<td>
		...
		<tr>
		  <td style="padding: 10px; line-height: 10px" bgcolor="#FFFFFF"><table width="100%" height="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#b5d6e6">
		    <s:iterator value="#request.personalNotice" id="u">
		      <tr>
		        <td width="2%" height="10%" align="right" bgcolor="#EBF4F5">发送人：</td>
		        <td width="19%" bgcolor="#FFFFFF"><s:property value="#u.from" /></td>
		        </tr>
		      <tr>
		        <td height="10%" align="right" bgcolor="#EBF4F5">通知标题：</td>
		        <td height="10%" width="20%" bgcolor="#FFFFFF"><s:property value="#u.title" /></td>
		        </tr>
		      <tr>
		        <td height="70%" align="right" bgcolor="#EBF4F5">通知内容：</td>
		        <td height="70%" valign="top" width="20%" bgcolor="#FFFFFF"><s:property value="#u.content" /></td>
		        </tr>
		      <tr>
		        <td height="10%" align="right" bgcolor="#EBF4F5">日期：</td>
		        <td height="10%" width="20%" bgcolor="#FFFFFF"><s:property value="#u.date.toString().substring(0,16)"/></td>
		        </tr>
		      </s:iterator>
		    <tr>
		      <td colspan="2" height="30" align="right" bgcolor="#FFFFFF"><table width="90" border="0" cellpadding="0" cellspacing="0" background="images/addnew002.gif">
		        <tr style="cursor:hand;">
		          <td><img src="images/addnew001.gif"></td>
		          <td onClick="javascript:window.location.href='<%=request.getContextPath()%>/PersonalNotice/listPersonalNotice.action'">后退</td>
