	...
	Ext.onReady(function(){
		...
		var typeTree = new Ext.tree.TreePanel({
			...
			loader: new Ext.tree.TreeLoader({
				dataUrl: "../showAssets/typetree.action",
			...
			listeners:{
				click:function (node, e){
					...
					parent.document.getElementById('listFrame').src="qurey.action?assets.assetsType.id="+id+"&assets.assetsType.name="+node.attributes.showname;
				}
			}
		});
