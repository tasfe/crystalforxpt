...
function Chose(Num) {
	...
	window.parent.document.getElementById('user.location.id').value = Num;

}
function init() {

	var l = window.parent.document.getElementById('user.location.id').value;
      ...
      var headerDataList=new Array("区域名称","区域详细介绍");
      var widthList=new Array("50%","50%");
      gridTree.setHeader(headerDataList,"0",widthList,true,"GridHead","This is a tipTitle of head href!","header status text","","");    
      ...
      gridTree.printTableTreeToElement("tableTreeLocation");
      var checked=false;
	  if(l){
