	...
	<body leftmargin="0" marginwidth="0">
		<s:form id="form" name="form" action="%{actionURI}.action" method="post" theme="simple">
			...
			<s:if test="actionURI=='save'">
				<input id="problemType.pid" name="problemType.pid" type="hidden" value="${pid}"></input>
			</s:if>
			<s:else>
				<s:hidden id="problemType.id" name="problemType.id"></s:hidden>
				<s:hidden id="problemType.pid" name="problemType.pid"></s:hidden>
				<s:hidden id="problemType.code" name="problemType.code"></s:hidden>
			</s:else>
			<table width="80%" height="" border="0" cellspacing="1" cellpadding="2" align="center" bgcolor="#b5d6e6">
				<tr height="28">
					...
					<td width="37%" bgcolor="#FFFFFF">
						<s:textfield id="problemType.problemCate" name="problemType.problemCate" cssStyle="width: 100%"/>				  </td>
					<td width="12%" align="center" nowrap bgcolor="#deebf1">
						<b>英文名称：</b>					</td>
					<td width="39%" bgcolor="#FFFFFF">
						<s:textfield id="problemType.problemCateSC" name="problemType.problemCateSC" cssStyle="width: 100%"/>				  </td>
				</tr>
		  </table>
