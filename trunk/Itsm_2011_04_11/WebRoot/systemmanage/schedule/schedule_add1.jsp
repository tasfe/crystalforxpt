...
<html>
	<head>
     ...
     function getDAO() { //取出类别
	       UserDAO.findUserNoCustomer(callbackusers);
          }
...
function showDialog(url, args, features) {
	...
	<body onLoad="getDAO()" leftmargin="0" topmargin="0" marginwidth="0"
		marginheight="0" style="padding: 0px;; cursor: default;">
    ...
    <td height="30" colspan="5" background="../images/main20100521_58.gif">
        ...
        <td width="98%" style="color:#333333; font-weight:bold;">新建预约登记</td>
      	</tr>
    	</table>
    </td>
  	</tr>
  		  	<tr>
    <td height="30" colspan="6" width="100%" background="../images/main20100521_58.gif">
    	<table width="100%" border=0 cellpadding=0 cellspacing=0>
      	<tr>
		...
		<s:form action="save.action" namespace="/schedule" method="post" theme="simple">
						...
						<table width="100%" border="0" cellspacing="1" cellpadding="2"
							...
							<tr>
								...
								<td width="87%" bgcolor="#FFFFFF">
									<!--
									<input type="hidden" name="schedule.userByExecutor.id"
										id="user_id" />
									<input type="text" name="user.name" id="user_fullname"
										readonly="readonly" />
									<a href="#"
										onclick="showDialog('/systemmange/schedule/selectPerson.jsp', {a:1, b:2}, {width:'300px', height:'200px', dependent:true});"><img
											src="../images/user.gif" border="0" />
									</a>
									 -->
						    <select id="users" name="schedule.userByExecutor.id" style="width: 100%"></select>
									...
									<table width="100%" height="100%" border="0" cellpadding="0"
										...
										<tr>
											<td colspan=3 bgcolor="#EBF4F5" style="padding: 5px">
												<textarea name="schedule.content" cols="3" rows="1"
							...
							<tr>
								...
								<td width="87%" bgcolor="#FFFFFF">
									&nbsp;&nbsp;
									<input type="text" name="schedule.adate" id="d12"
										onclick="WdatePicker()" />
							...
							<tr>
								<td width="13%" align="right" valign="middle" bgcolor="#deebf1"
									height="22">
									具体时间:
								</td>
