...
<tr> 
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" background="../images/m_mpbg.gif"> 
        ...
        <td width="98%" background="../images/main20100521_582.gif" style="color:#FFFFFF; font-weight:bold;">预约登记:</td>
      </tr>
    </table> 
    <br/>
    <br/>
    <s:form action="save.action" name="myForm" method="post">
    <table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" bgcolor="#b5d6e6">
      <tr class="top">
        <td height="35" width="80" align="right"><div align="right">执行人：</div></td>
        <td><input type="hidden" name="schedule.userByExecutor.id" id="user_id"/><input type="text" name="user.name" id="user_fullname" readonly="readonly" /><a href="#" onclick="showDialog('/systemmange/schedule/selectPerson.jsp', {a:1, b:2}, {width:'300px', height:'200px', dependent:true});
      ...
      <tr>
        ...
        <td colspan="3" valign="middle"><textarea name="schedule.content" cols="3" rows="1" style="width:60%; height:45px;"></textarea></td>
        </tr>
      <tr>
        <td height="30" align="right">执行日期：</td>
        <td><input type="text" name="schedule.adate" id="d12" onclick="WdatePicker()"/><img onclick="WdatePicker({el:$dp.$('d12')})" src="../js/DatePicker/skin/datePicker.gif" width="16" height="22" />
        </td>
