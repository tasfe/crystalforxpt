		  ...
		  <tr> 
			<td style="padding: 9px; padding-top: 6px" bgcolor="#FFFFFF" valign="top">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
				  ...
				  <tr>
				    <td valign="top"><table width="100%" cellpadding="2" cellspacing="1" bgcolor="#b5d6e6">
                      <tr title="配置项编码" bgcolor="#f9f9f9">
                        <td width="14%" height="27" nowrap="nowrap" bgcolor="#EBF4F5"></td>
                        <td width="86%" valign="top" bgcolor="#FFFFFF"><table cellspacing="0" cellpadding="0" width="40%" border="0">
                            <tbody>
                              <tr>
                                <td width="1%"><input type="radio" value="aaa" name="Text_1" /></td>
                                <td title="aaa" valign="top" nowrap="nowrap" width="30%"><div>aaa</div></td>
                                <td width="1%"><input type="radio" value="bbb" name="Text_1" /></td>
                                <td title="bbb" valign="top" nowrap="nowrap" width="30%"><div>bbb</div></td>
                                <td width="1%"><input type="radio" value="ccc" name="Text_1" /></td>
                                <td title="ccc" valign="top" nowrap="nowrap" width="30%"><div>ccc</div></td>
                              </tr>
                              <tr></tr>
                            </tbody>
                        </table></td>
                      </tr>
                      <tr title="使用人" bgcolor="#f9f9f9">
                        <td width="14%" height="27" nowrap="nowrap" bgcolor="#EBF4F5">使用人:</td>
                        <td width="86%" valign="top" bgcolor="#FFFFFF"><table cellspacing="0" cellpadding="0" width="100%" border="0">
                            <tbody>
                              <tr>
                                <td width="32%" nowrap><input id="Text_2" name="Text_2" />
                                    <input id="Text_2_LB" readonly="readOnly" name="Text_2_LB" />                                </td>
                                <td width="68%">&nbsp;&nbsp;&nbsp;<img style="cursor:hand;" src="../../img/check.jpg" name="popcal" width="18" height="18" border="0" align="absmiddle" id="popcal" title="点击查找.." onclick="window.open('equipmentuser.jsp','','width=500,height=400,scrollbars=yes,menubar=no,resizable=yes,top=150,left=150,status=yes')" /></td>
                              </tr>
                            </tbody>
                        </table></td>
                      </tr>
                      <tr title="放置地点" bgcolor="#f9f9f9">
                        <td width="14%" height="27" nowrap bgcolor="#EBF4F5">放置地点:</td>
                        <td width="86%" valign="top" bgcolor="#FFFFFF"><input style="width:90%" id="Text_3" name="Text_3" /></td>
                      </tr>
                      <tr title="设备型号" bgcolor="#f9f9f9">
                        <td width="14%" height="27" nowrap="nowrap" bgcolor="#EBF4F5">设备型号:</td>
                        <td width="86%" valign="top" bgcolor="#FFFFFF"><input style="width:90%" id="Text_32" name="Text_32" /></td>
                      </tr>
                      <tr title="财务编号" bgcolor="#f9f9f9">
                        <td width="14%" height="27" nowrap="nowrap" bgcolor="#EBF4F5">财务编号:</td>
                        <td width="86%" valign="top" bgcolor="#FFFFFF"><input style="width:90%" id="Text_33" name="Text_33" /></td>
                      </tr>
                      <tr title="出厂编号" bgcolor="#f9f9f9">
                        <td width="14%" height="27" nowrap="nowrap" bgcolor="#EBF4F5">出厂编号:</td>
                        <td width="86%" valign="top" bgcolor="#FFFFFF"><input style="width:90%" id="Text_34" name="Text_34" /></td>
                      </tr>
                      <tr title="应用范围" bgcolor="#f9f9f9">
                        <td width="14%" height="27" nowrap="nowrap" bgcolor="#EBF4F5">应用范围:</td>
                        <td width="86%" valign="top" bgcolor="#FFFFFF"><input style="width:90%" id="Text_35" name="Text_35" /></td>
                      </tr>
                      <tr title="供货商" bgcolor="#f9f9f9">
                        <td width="14%" height="27" nowrap="nowrap" bgcolor="#EBF4F5">供货商:</td>
                        <td width="86%" valign="top" bgcolor="#FFFFFF"><input style="width:90%" id="Text_36" name="Text_36" /></td>
                      </tr>
                      <tr title="联系方式" bgcolor="#f9f9f9">
                        <td width="14%" height="27" nowrap="nowrap" bgcolor="#EBF4F5">联系方式:</td>
                        <td width="86%" valign="top" bgcolor="#FFFFFF"><input style="width:90%" id="Text_37" name="Text_37" /></td>
                      </tr>
                      <tr title="保修期" bgcolor="#f9f9f9">
                        <td width="14%" height="27" nowrap="nowrap" bgcolor="#EBF4F5">保修期:</td>
                        <td width="86%" valign="top" bgcolor="#FFFFFF"><input style="width:90%" id="Text_38" name="Text_38" /></td>
                      </tr>
                      <tr title="购货日期" bgcolor="#f9f9f9">
                        <td width="14%" height="27" nowrap="nowrap" bgcolor="#EBF4F5">购货日期:</td>
                        <td width="86%" valign="top" bgcolor="#FFFFFF"><input style="width:90%" id="Text_39" name="Text_39" /></td>
                      </tr>
                      <tr title="设备单价" bgcolor="#f9f9f9">
                        <td width="14%" height="27" nowrap="nowrap" bgcolor="#EBF4F5">设备单价:</td>
                        <td width="86%" valign="top" bgcolor="#FFFFFF"><input style="width:90%" id="Text_310" name="Text_310" /></td>
                      </tr>
                      <tr title="设备来源" bgcolor="#f9f9f9">
                        <td width="14%" height="27" nowrap="nowrap" bgcolor="#EBF4F5">设备来源:</td>
                        <td width="86%" valign="top" bgcolor="#FFFFFF"><input style="width:90%" id="Text_311" name="Text_311" /></td>
                      </tr>
                      <tr title="软件配置" bgcolor="#f9f9f9">
                        <td width="14%" height="27" nowrap="nowrap" bgcolor="#EBF4F5">软件配置:</td>
                        <td width="86%" valign="top" bgcolor="#FFFFFF"><input style="width:90%" id="Text_312" name="Text_312" /></td>
                      </tr>
                    </table></td>
				    </tr>
				  <tr onMouseDown="document.getElementById('Layer5').style.visibility='hidden'">
