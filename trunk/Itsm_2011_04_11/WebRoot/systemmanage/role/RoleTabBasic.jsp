<%@ page language="java" contentType="text/html; charset=utf-8"
	isELIgnored="false"%><%@page import="com.combanc.itsm.pojo.Document"%>
...
<body onLoad="init()" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0"	style="padding: 7px; cursor: default; overflow-x:hidden" onContextMenu="return false" onmousedown="document.getElementById('Layer1').style.visibility='hidden'">
			<s:form action="%{actionURI}.action" method="post" theme="simple" target="mainFrame">
			...
			<s:else>	    	
				<s:hidden id="role.type" name="role.type"></s:hidden>
				 <s:hidden id="role.roleType" name="role.roleType"></s:hidden>
			</s:else>
													<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#b5d6e6">
														<tr>
															<td width="15%" height="25" align="center" nowrap bgcolor="#deebf1">角色名称<span style = 'color : red; vertical-align   :middle'>*</span>:</td>
														   ...
														   <select id="role.roleType" name="role.roleType" disabled="true">
                                                           ...
                                                           --%><s:select id="role.roleType" list="#{1:'工程师',2:'经理',3:'用户',4:'管理员'}"  label="role.roleType" listKey="key" listValue="value"  headerKey="0" value="role.roleType" disabled="true">
                                                           </s:select>
														 ...
														 <tr>
															...
															<s:select id="role.useFor" list="#{1:'固定角色：总是包含所有选中人员',2:'浮动角色：根据申请人所在的地理位置判断',3:'手动角色：由上一环节操作人临时选择	'}"  label="role.useFor" listKey="key" listValue="value"  headerKey="0" value="role.useFor" >
                                                           </s:select>
																<select id="role.useFor" name="role.useFor">
																	<option id="category1" value="1">
																		固定角色：总是包含所有选中人员																	</option>
																	<option id="category2" value="2">
																		浮动角色：根据申请人所在的地理位置判断																	</option>
																	<option id="category3" value="3">
																		手动角色：由上一环节操作人临时选择																	</option>				
																</select>
																<script type="text/javascript">
							                                       var select = document.getElementById('role.useFor');
							                                       for (var i = 0; i < 3; i++) {
							                                        	if (<s:property value="role.useFor" /> == select.options[i].value) {
														...
														<tr>
															...
															<td width="85%" valign="top" bgcolor="#FFFFFF" style="padding: 0px; padding-bottom:10px;" colspan="3">
																<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
																	<tr>
																		<td height="80" align="left" bgcolor="white" style="padding-left:2px"> <textarea name="showUsernames" id="showUsernames" cols="89" rows="3"	style="height: 50px; font-family: Courier New; border:1px solid #b5d6e6"><s:property value="namesList"/></textarea></td>
