...
.divtitle {
	...
	Ext.onReady(function(){
		...
		var typeTree = new Ext.tree.TreePanel({
			...
			listeners:{
				click:function (node, e){
				    var id=node.id;
					if(id!=0){
					   parent.document.getElementById('listFrame').src="add.action?pid="+id;
					}
				}
			}
		});
        ...
        {
         tree=document.getElementById("d");
        
		window.location='add.action';
                }
        
        function initTree(choose){ 
      
		var topframe = parent.frames.topFrame;
		topframe.location = "top.action?type="+choose.value;
	}          	
