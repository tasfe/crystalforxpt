...
<%
	...
	String requestURI = request.getContextPath() + "/domainregister/list.action";
%>
<html>
	<head>
		<title>域名申请管理</title>
...
function open1(id)
{
   ...
   diag.Width = 800;
	...
	diag.URL = "show.action?domainRegisterId="+id;
	diag.show();
...
document.form1.submit();
	...
	<s:form action="/domainregister/query.action" method='post' theme="simple">
      ...
      <td width="98%" background="../images/main20100521_582.gif" style="color:#FFFFFF; font-weight:bold;">域名申请</td>
	    ...
	    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#b5d6e6">   
         <tr bgcolor="#b5d6e6">
          ...
          <tags:button code="search" menu="102">
       ...
       <tr>
          ...
          <td bgcolor="#deebf1" align="center">
          <tags:button code="reset" menu="102">
	   ...
	   <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
	        <tr>
				<td align="right">
				 <tags:button code="export" menu="102">
				  <input type="button" class="mmBtn" value="导出域名申请" onClick="window.location='export.action'">				
				</tags:button>
				  <tags:button code="add" menu="102">
			...
			<s:iterator value="pageBean.list" var="domainRegister">
			 <tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#e3f0f7'" onMouseOut="this.bgColor='#FFFFFF'">
			  ...
			  <td align="center" class="zczb_qua">
			  	<tags:button code="approve" menu="102">
				  <s:if test="#domainRegister.state==0"> <img src="../images/edt.gif">
				<a href="updateInput.action?domainRegisterId=<s:property value="id"/>">待审批</a></s:if>
				 <s:if test="#domainRegister.state==1"> <img src="../images/edt1.gif" >
				已审批</s:if>
				</tags:button>
			  </td>
			  <td align="center" class="zczb_qua">
				<tags:button code="delete" menu="102">
				  <s:if test="#domainRegister.state==0"> 	<img src="../images/del.gif">
				<a href="delete.action?domainRegisterId=<s:property value="id"/>" onClick="javascript:return del()">删除</a></s:if>
				 <s:if test="#domainRegister.state==1"> <img src="../images/del1.gif" >
				删除</s:if>
				</tags:button>
			  </td>
			  <td align="center" class="zczb_qua">
			  <tags:button code="detail" menu="102">
			  <img src="../images/icons/icon013a1.gif" height="15" width="15">
				<a href="show.action?domainRegisterId=<s:property value="id"/>" target="_blank">打印</a>
			 </tags:button>
			  </td>
			 </tr>
			</s:iterator>
