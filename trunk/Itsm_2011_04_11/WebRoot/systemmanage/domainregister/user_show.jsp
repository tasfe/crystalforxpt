...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0"  class="tab1">
  ...
  <tr>
    <td colspan="6" align="center"><br><br><br>
      <h2><strong>中国人民大学校园IP地址申请表</strong><br>
      <br>
    </h2></td>
    </tr>
    
    <tr>
    <td  align="right"  colspan="4"><input type="button" value=" 返回 "  class="mmBtn" onClick="window.history.go(-1)"></td>
  </tr>
  <tr>
    <td height="42" colspan="6">本申请表仅用于校内单位申请中国人民大学校园网静态IP地址。</td>
  </tr>
  <tr>
    <td colspan="6"><table width="100%" border="1" cellspacing="1" cellpadding="1" bgcolor="#000000">
      <tr>
  ...
  <tr>
    <td height="87" colspan="6" class="line2">
    <br>
  ...
  <br>
  <tr>
    <td width="115" height="39">单位负责人：</td>
    <td width="97"><s:property value="ipAddress.unitsLeader"/> </td>
    <td width="111">（单位公章）</td>
    <td width="99">申请人签名：</td>
    <td width="87"><s:property value="ipAddress.application"/> </td>
    <td width="91"><s:date name="ipAddress.applicationDate"  format="yyyy-MM-dd"/></td>
  </tr>
     <tr>
    <td height="48" colspan="6">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td height="88" colspan="6">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="6"><table width="100%" border="1" cellspacing="0" cellpadding="0" bgcolor="#000000">
      <tr>
