...
<html>
	...
	<frameset rows="180,*" cols="*" framespacing="5" bordercolor="#f8f9f4" frameborder="yes">
		...
		<frame id="listFrame" name="listFrame" title="listFrame" src="list.action?type=<s:property value="type"/>&pid=<s:property value="pid"/>" scrolling="auto" frameborder="0" style="BORDER:#91A9BD 0px solid"/>
	</frameset>
	<noframes>
		<body>
		</body>
