			...
			<table width="80%" height="75" border="0" cellspacing="1"
				...
				<tr style="height: 25">
					...
					<td width="88%" bgcolor="#FFFFFF">
					    <input type="text" id="assetsType.name" name="assetsType.name" Style="width: 100%">
					</td>
				</tr>
				<tr style="height: 25">
					...
					<td bgcolor="#FFFFFF">
						<s:textfield id="assetsType.description" name="assetsType.description" 	cssStyle="width: 100%"></s:textfield>
					</td>
				</tr>
				<tr style="height: 25">
					<td width="120" align="right" bgcolor="#deebf1">
					...
					<td bgcolor="#FFFFFF">
<input type="hidden" name="assetsType.pid" id="assetsTypeid" Style="width: 100%" value="">
<input type="text" name="assetsTypename" id="assetsTypename" onClick="document.getElementById('assetsType').style.visibility='visible'" readonly value="请选择" Style="width: 100%">
