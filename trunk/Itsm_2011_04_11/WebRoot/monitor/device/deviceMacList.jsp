...
<table cellspacing=0 cellpadding=0 border=0 width="100%">   
  <tr>
    ...
    <td width="98%" background="<%=path%>/images/main20100521_582.gif" style="color:#FFFFFF; font-weight:bold;">MAC转发表</td>
  </tr>
</table>
  ...
  <tr>
    <td height="20" colspan="5" background="../images/main20100521_58.gif"><table width="50%" border=0 cellpadding=0 cellspacing=0>
      <tr>
        ...
        <td width="98%" style="color:#333333; font-weight:bold;">MAC转发表：<s:property value="monitorDevice.ip"/></td>
      </tr>
    </table></td>
  </tr>
</table>
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#b5d6e6">
      <tr bgcolor="#b5d6e6">
        ...
        <td align="center" nowrap bgcolor="#deebf1">端口</td>          
        <td align="center" nowrap bgcolor="#deebf1">接口</td>
        <td align="center" nowrap bgcolor="#deebf1">接口描述</td>
      </tr>
      <%int i=1; %>
      <s:iterator value="#request.devMacEntryList" var="macEntry">
