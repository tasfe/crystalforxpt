					...
					<td valign="top" bgcolor="#FFFFFF">
						<table width="100%" height="100%" border="0" cellpadding="4"
							...
							<tr>
								...
								<td valign="top" bgcolor="#EBF4F5">
									<s:if test="serviceRequest.state==0">
          待派单
          </s:if>
					...
					<td valign="top" bgcolor="#FFFFFF">
						<table width="100%" height="100%" border="0" cellpadding="4"
							...
							<tr>
								...
								<td nowrap bgcolor="#EBF4F5" class="td-detail">
									<s:if test="serviceRequest.serviceLvl==1">
                                                                                                  非常满意
                                  </s:if>
									<s:elseif test="serviceRequest.serviceLvl==2">
                                                                                               满意
                                 </s:elseif>
									<s:elseif test="serviceRequest.serviceLvl==3">
                                                                                               满意
                                 </s:elseif>
								</td>
							</tr>
							<tr>
								...
								<td nowrap bgcolor="#EBF4F5" class="td-detail">
									<s:property value="serviceRequest.feedback" />
								</td>
							</tr>
						</table>
					</td>
