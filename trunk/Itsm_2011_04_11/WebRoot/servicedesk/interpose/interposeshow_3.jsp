							...
							<td style="padding-top: 8px"> <a name="SetApprove"></a>
								...
								<div id="divNot" style="display: none">
									<table width="100%" border="1" cellpadding="1" cellspacing="0" class="tb-list">
										...
										<s:form name="frmAct10" action="../prob/default.asp?NowAction=db_pro&type=ProjectAno" method="post" target="sum">
											<input type=hidden name=ProNo value="C10081900001">
												...
												<td style="padding: 10px" bgcolor="#FFFFFF">
													<table width="100%" border="0" cellspacing="2" cellpadding="4" class="datagrid">
														<tr>
															...
															<td width="86%" colspan=3 class="td-detail">C10081900001</td>
														</tr>
														<tr>
								...
								<div id="divCat" style="display: none">
									<table width="100%" border="1" cellpadding="1" cellspacing="0" class="tb-list">
										<s:form name="frmCat" action="../prob/default.asp?NowAction=dbdeal&type=FeedBack" method="post" target="sum">
											<input type=hidden name=RequNo value="C10081900001">
											<tr>
											...
											<tr>
												<td style="padding: 10px" bgcolor="#FFFFFF">
													<table width="100%" border="0" cellspacing="2" cellpadding="4">
														<tr>
															<td width="14%" class="td-left">工单号:</td>
															<td class="td-detail">C10081900001</td>
														</tr>
													...
													<table width="100%" border="0" cellspacing="2" cellpadding="4">
														...
														<tr>
															<td style="padding: 5px" class="td-right">
																<iframe frameborder="0" height="130" width="90%" scrolling="yes" style="border: 1px inset" name="l1" id="l1" src="../inci/?NowAction=requestlist&value=&OLDno=C10081900001"></iframe>
															</td>
														</tr>
													</table>
												</td>
												...
												<td style="padding: 10px" bgcolor="#FFFFFF">
													<table width="100%" border="0" cellspacing="2" cellpadding="4">
														...
														<tr>
															...
															<td width="86%" colspan=3 class="td-detail">
																<textarea name="ITMind" rows=4 style="width: 70%">tes6t </textarea>
															</td>
														</tr>
													</table>
												</td>
								...
								<div id="divYan" style="display: none">
									<table width="100%" border="1" cellpadding="1" cellspacing="0" class="tb-list">
										...
										<form name="frmTra" action="../prob/default.asp?NowAction=dbdeal&type=SetYan" method="post" target="sum">
											<input type=hidden name=RequNo value="C10081900001">
											<tr>
												<td style="padding: 10px" bgcolor="#FFFFFF">
													<table width="100%" border="0" cellspacing="2" cellpadding="4">
								...
								<div id="divAct" style="display: none">
									<table width="100%" border="1" cellpadding="1" cellspacing="0" class="tb-list">
										...
										<s:form name="frmAct" action="../prob/default.asp?NowAction=dbdeal&type=ApproveAct&FC=1" method="post" target="sum">
											...
											<input name="Grade" value="OK" type="hidden">
											...
											<tr>
												<td style="padding: 10px" bgcolor="#FFFFFF">
													<table width="100%" border="0" cellspacing="2" cellpadding="4">
														<tr>
															<td width="14%" class="td-left">工单号:</td>
															<td colspan=3 class="td-detail">C10081900001</td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td width="86%" colspan=3 class="td-detail">
																<table width="20"  border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td>
																			<select name="Essential" style="height: 20px; width: 80px" onChange="window.sla.location='../desk/?NowAction=sla&Go=1&TheTime=2010-8-19 9:17:54&NoChan=1&Type=inci&RequObj=|1,&RequPep=|user|&Ess='+document.getElementById('Essential').value+'&Eme='+document.getElementById('Emergency').value">
																		...
																		<td>
																			<select name="Emergency" style="height: 20px; width: 80px" onChange="window.sla.location='../desk/?NowAction=sla&Go=1&TheTime=2010-8-19 9:17:54&NoChan=1&Type=inci&RequObj=|1,&RequPep=|user|&Ess='+document.getElementById('Essential').value+'&Eme='+document.getElementById('Emergency').value">
																				<option value="3">紧急度</option>
