						...
						<tr>
							<td style="padding-top: 8px"> <a name="SetApprove"></a>
								...
								<div id="divNot" style="display: none">
									<table width="100%" border="1" cellpadding="1" cellspacing="0" class="tb-list">
										...
										<s:form name="frmAct10" action="../prob/default.asp?NowAction=db_pro&type=ProjectAno" method='post' target="sum">
											<input type=hidden name=ProNo value="R10082400001">
								...
								<div id="divCat" style="display: none">
									<table width="100%" border="1" cellpadding="1" cellspacing="0" class="tb-list">
										<s:form name="frmCat" action="../prob/default.asp?NowAction=dbdeal&type=FeedBack" method='post' target="sum">
											<input type=hidden name=RequNo value="R10082400001">
											<tr>
											...
											<tr>
												<td style="padding: 10px" bgcolor="#FFFFFF">
													<table width="100%" border="0" cellspacing="2" cellpadding="4">
														<tr>
															<td width="14%" class="td-left">工单号:</td>
															<td class="td-detail">R10082400001</td>
														</tr>
														<tr>
														...
														<tr>
															<td style="padding: 5px" class="td-right">
																<iframe frameborder="0" height="130" width="90%" scrolling="yes" style="border: 1px inset" name="l1" id="l1" src="inci.action"></iframe>
															</td>
														</tr>
													</table>
												</td>
														...
														<tr>
															...
															<td width="86%" colspan=3 class="td-detail">
																<table width="20"  border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td>
																			<select name="Essential" style="height: 20px; width: 80px" onChange="window.sla.location='../desk/?NowAction=sla&Go=1&TheTime=2010-8-24 10:27:22&NoChan=1&Type=inci&RequObj=|1,&RequPep=|Administrator|&Ess='+document.getElementById('Essential').value+'&Eme='+document.getElementById('Emergency').value">
																				<option value="0">影响度</option>
																				
																				<option value="1">↑_低</option>
																				
																				<option value="2">↑_中</option>
																		...
																		<td>
																			<select name="Emergency" style="height: 20px; width: 80px" onChange="window.sla.location='../desk/?NowAction=sla&Go=1&TheTime=2010-8-24 10:27:22&NoChan=1&Type=inci&RequObj=|1,&RequPep=|Administrator|&Ess='+document.getElementById('Essential').value+'&Eme='+document.getElementById('Emergency').value">
																				<option value="0">紧急度</option>
								...
								<div id="divRef" style="display: none">
									<table width="100%" border="1" cellpadding="1" cellspacing="0" class="tb-list">
										<tr>
											<th style="padding: 0px">&nbsp;<img src="../img/cate.gif" align="absMiddle">&nbsp;干预工作流程<br></th>
										</tr>
										<s:form name="frmRef2" method='post' target="sum">
											...
											<tr>
												<td style="padding: 10px" bgcolor="#FFFFFF">
													<table width="100%" border="0" cellspacing="2" cellpadding="4">
														<tr>
															<td width="14%" class="td-left">工单号:<br></td>
															<td width="86%" colspan=3 class="td-detail"><s:property value="serviceRequest.requestNo"/><br></td>
														</tr>
														<tr>
															<td width="14%" class="td-left" valign="top">将请求转交至:<br></td>
															<td width="86%" colspan=3 class="td-detail">
									...
									<table cellspacing=0 cellpadding=0 border=0 width="100%">
										<tr>
											<td align=right nowrap style="padding-top: 8px">&quot;<input type="button" class="mmBtn" value="转交" onClick="if(confirm('你确认要转交吗？')){if(document.getElementById('TurnTo').value!=''){window.sum.location=document.getElementById('TurnTo').value}else{alert('请选择正确的转交环节！')}}" name="button">
											<br></td>
										</tr>
									</table>
								</div>
