        			...
        			<tr> 
          				<td height="136" valign="top" bgcolor="#FFFFFF">             
            				<table cellspacing=2 cellpadding=4 border=0 width="100%" style="font-size: 12px"> 
              					<tr> 
                					<td width="13%" nowrap class="subtitle">用户名</td>
                					<td width="35%" nowrap class="subtitle" colspan="2">真实姓名</td>								
                					<td width="25%" nowrap class="subtitle">待处理任务</td>
                					<td width="25%" nowrap class="subtitle">处理中的任务</td>
                					<td height="13" nowrap class="subtitle" width="1%">选择</td>
              					...
              					<s:iterator value="role.userses" var="user" status='st'>
        							<tr bgcolor="#FFFFFF" onMouseOver="this.bgColor='#e3f0f7'" onMouseOut="this.bgColor='#FFFFFF'">
										<td width="13%" nowrap class="subtitle"><s:property value="username"/></td>
          								...
          								<td height="13" nowrap class="subtitle" width="1%"><input name="chose" type="radio" value="<s:property value='id'></s:property>" style="border: 0px" onClick="if(this.checked){Chose(this.value)}"></td>
        							</tr>
      							</s:iterator>             
								<tr bgcolor="#F9F9F9"> 
