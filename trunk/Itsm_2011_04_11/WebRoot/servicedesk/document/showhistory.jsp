					...
					<td bgColor="white" valign="top">
						<table width="100%" border="0" cellspacing="1" cellpadding="2"
							...
							<tr>
								...
								<td width="87%" bgcolor="#FFFFFF">
								<s:property value="dcold.summary"/>
								</td>
							</tr>
							<tr>
								<td width="13%" height="5%" align="right" valign="middle"
								...
								<td width="87%" bgcolor="#FFFFFF">
									<s:property value="dcold.keyword"/>
								</td>
							</tr>
							<tr>
								<td width="13%" height="5%" align="right" valign="middle"
								...
								<td bgcolor="#FFFFFF">
								<s:property value="dcold.version"/>
								</td>
							</tr>
							<tr>
								...
								<td width="87%" bgcolor="#FFFFFF">
							    <s:property value="dcold.context" escape="false"/>
									<%--<FCK:editor instanceName="dcold.context" toolbarSet="Mybasic"
										basePath="/fckeditor" height="100%" value="${dcold.context}">
										<FCK:config CustomConfigurationsPath="${pageContext.request.contextPath}/js/fckeditor/myconfig.js" />
										</FCK:editor>
								--%></td>
							</tr>
							<tr>
								<td rowspan="2" align="right" valign="middle" bgcolor="#deebf1" class="td-left-s">
