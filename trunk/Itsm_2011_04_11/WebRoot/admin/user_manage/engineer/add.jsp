...
<div style="color:red">
    ...
    <input type="hidden" name="finance.PBaseset.id" value="<%=pid %>"/>
      ...
      <tr class="top">
        <td height="35" width="80" align="right"><div align="right">工作组名称：</div></td>
        <td><input type="text" name="finance.FTitle" /></td>
        <td align="right"><div align="right"></div></td>
        <td></td>
      </tr>
      <tr>
        <td height="35" width="80" align="right"><div align="right">应用范围：</div></td>
        <td><input type="text" name="finance.FMoney" verify="Number" /></td>
      </tr>
         
      <tr>
        <td height="35" width="80" align="right"><div align="right">成员：</div></td>
