...
<table width="100%" border="0" cellspacing="0" cellpadding="0"> 
  <tr>
	...
	<table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="#C0CCDD" id="content"> 
		<tr class="top"> 
          <td width="15%"><div align="center"><strong>登录名</strong></div></td>  
          <td width="20%"><div align="center"><strong>用户全名</strong></div></td>
          <td width="15%"><div align="center"><strong>用户类型</strong></div></td> 
          <td width="30%"><div align="center"><strong>地理位置</strong></div></td> 
          <td width="10%"><div align="center"><strong>编辑</strong></div></td> 
          <td width="10%"><div align="center"><strong>删除</strong></div></td> 
        </tr> 

		<tr onmouseout="this.style.backgroundColor=''" onmouseover="this.style.backgroundColor='ecf5ff'"> 
            <td align="center">康邦科技</td>  
            <td class="name"><div align="center">咨询顾问</div></td>
            <td height="25" class="name"><div align="center">工程师</div></td> 
            <td><div align="center">北京区域</div></td> 
