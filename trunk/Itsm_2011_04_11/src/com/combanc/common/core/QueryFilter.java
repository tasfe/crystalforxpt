package com.combanc.common.core;
...
import com.combanc.common.util.ParamUtil;
...
public class QueryFilter {
	...
	public QueryFilter(HttpServletRequest request) {
		...
		Integer limit = PageBean.DEFAULT_PAGE_SIZE;
		...
		this.pageBean = new PageBean(start.intValue(), limit.intValue());
	}
