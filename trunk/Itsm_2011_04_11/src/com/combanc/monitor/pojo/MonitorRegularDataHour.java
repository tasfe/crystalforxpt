...
/**
 * MonitorRegularDataHour entity. @author MyEclipse Persistence Tools
 */

public class MonitorRegularDataHour extends MonitorBaseRegularData implements java.io.Serializable {
	...
	/** default constructor */
	public MonitorRegularDataHour() {
	}

	/** full constructor */
	public MonitorRegularDataHour(String ip, String interface_, Long txByte,
