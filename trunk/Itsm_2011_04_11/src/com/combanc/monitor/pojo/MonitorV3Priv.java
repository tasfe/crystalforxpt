...
/**
 * MonitorV3Priv entity. @author MyEclipse Persistence Tools
 */

public class MonitorV3Priv implements java.io.Serializable {
	...
	/** default constructor */
	public MonitorV3Priv() {
	}

	/** minimal constructor */
	public MonitorV3Priv(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public MonitorV3Priv(Integer id, Integer protocol, String name,
