...
public final class ShadowStyle extends Style {
	...
	/**
	 * The angle of the shadow. Valid values are 0 to 360˚. The default value is
	 * 45
	 */
	...
	/**
	 * The color of the shadow in hex code (without #). The default value is
	 * CCCCCC
	 */
	...
	/**
	 * The alpha transparency value for the shadow color. Valid values are 0 to
	 * 100. For example, 25 sets a transparency value of 25%.
	 */
	 ...
	 * value is 4. Values that are a power of 2 (such as 2, 4, 8, 16 and 32) are
	...
	/**
	 * The amount of vertical blur. Valid values are 0 to 255. The default value
	 * is 4. Values that are a power of 2 (such as 2, 4, 8, 16 and 32) are
	 * optimized to render more quickly than other values.
	 */
	 ...
	 * is medium quality, and a value of 3 is high quality. Shadow with lower
