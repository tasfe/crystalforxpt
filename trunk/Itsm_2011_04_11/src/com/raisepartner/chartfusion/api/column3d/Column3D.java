...
public class Column3D extends com.raisepartner.chartfusion.api.Chart {
	...
	/**
	 * Type: Boolean Range value: 0/1 Description : Whether to show column
	 * shadows?
	 */
	...
	/**
	 * @see com.raisepartner.chartfusion.api.column3d.Column3DSet
	 */
	public Column3DSet createSetNode() {
		Column3DSet node = new Column3DSet();
		addNode(node);
		return node;
	}

	/**
	 * @see com.raisepartner.chartfusion.api.column3d.Column3DVLine
	 */
	public Column3DVLine createVLineNode() {
		Column3DVLine node = new Column3DVLine();
		addNode(node);
		return node;
	}

	/**
	 * @see com.raisepartner.chartfusion.api.column3d.Column3DTrendLines
	 */
	public Column3DTrendLines createTrendLinesNode() {
		Column3DTrendLines node = new Column3DTrendLines();
		addNode(node);
		return node;
	}
