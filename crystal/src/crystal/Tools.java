	...
	public static boolean pingSegment(String subnet, String snet, String mask) {
		...
		for (i = 0; i < 256 - mask3value; i++) {
			for (j = 0; j < 256 - mask4value; j++) {
				...
				display("Ping子网 " + subnet + " 网段 " + snet + " / " + mask
						+ " ，IP：" + ipstr);
				try {
